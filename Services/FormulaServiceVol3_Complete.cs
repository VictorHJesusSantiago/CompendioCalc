    ...
    private void AdicionarAnaliseFuncionalCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 3 }, new() { Simbolo = "x2", Nome = "x2", ValorPadrao = 4 }, new() { Simbolo = "p", Nome = "p", ValorPadrao = 2, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x1", Nome = "x1", ValorPadrao = -2 }, new() { Simbolo = "x2", Nome = "x2", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nf", Nome = "||f||p", ValorPadrao = 3, ValorMin = 0 }, new() { Simbolo = "ng", Nome = "||g||q", ValorPadrao = 4, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "xx", Nome = "<x,x>", ValorPadrao = 25, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nx", Nome = "||x||", ValorPadrao = 2, ValorMin = 0 }, new() { Simbolo = "ny", Nome = "||y||", ValorPadrao = 7, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "te1", Nome = "||Te1||", ValorPadrao = 3, ValorMin = 0 }, new() { Simbolo = "te2", Nome = "||Te2||", ValorPadrao = 4, ValorMin = 0 } ],
    ...
    private void AdicionarTeoriaMedidaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "a", ValorPadrao = 2 }, new() { Simbolo = "b", Nome = "b", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "c", Nome = "constante", ValorPadrao = 4 }, new() { Simbolo = "a", Nome = "a", ValorPadrao = 0 }, new() { Simbolo = "b", Nome = "b", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "f", Nome = "densidade", ValorPadrao = 2.5, ValorMin = 0 }, new() { Simbolo = "muA", Nome = "mu(A)", ValorPadrao = 4, ValorMin = 0 } ],
    ...
    private void AdicionarTeoriaCategoriasCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "na", Nome = "|A|", ValorPadrao = 3, ValorMin = 0 }, new() { Simbolo = "nb", Nome = "|B|", ValorPadrao = 5, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "na", Nome = "|A|", ValorPadrao = 4, ValorMin = 0 }, new() { Simbolo = "nb", Nome = "|B|", ValorPadrao = 7, ValorMin = 0 } ],
    ...
    private void AdicionarAnaliseNumericaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x0", Nome = "x0", ValorPadrao = 0 }, new() { Simbolo = "y0", Nome = "y0", ValorPadrao = 2 }, new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 10 }, new() { Simbolo = "y1", Nome = "y1", ValorPadrao = 12 }, new() { Simbolo = "x", Nome = "x", ValorPadrao = 4 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "a", ValorPadrao = 0 }, new() { Simbolo = "b", Nome = "b", ValorPadrao = 2 }, new() { Simbolo = "fa", Nome = "f(a)", ValorPadrao = 1 }, new() { Simbolo = "fb", Nome = "f(b)", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "a", ValorPadrao = 0 }, new() { Simbolo = "b", Nome = "b", ValorPadrao = 2 }, new() { Simbolo = "fa", Nome = "f(a)", ValorPadrao = 1 }, new() { Simbolo = "fm", Nome = "f(m)", ValorPadrao = 2 }, new() { Simbolo = "fb", Nome = "f(b)", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "y", Nome = "y_n", ValorPadrao = 1 }, new() { Simbolo = "h", Nome = "h", ValorPadrao = 0.1 }, new() { Simbolo = "f", Nome = "f(t_n,y_n)", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "smax", Nome = "sigma_max", ValorPadrao = 100, ValorMin = 0.0001 }, new() { Simbolo = "smin", Nome = "sigma_min", ValorPadrao = 0.5, ValorMin = 0.0001 } ],
    ...
    private void AdicionarGeometriaAlgebricaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "d", Nome = "grau d", ValorPadrao = 3, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "a", ValorPadrao = -1 }, new() { Simbolo = "b", Nome = "b", ValorPadrao = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 1 }, new() { Simbolo = "y1", Nome = "y1", ValorPadrao = 2 }, new() { Simbolo = "x2", Nome = "x2", ValorPadrao = 3 }, new() { Simbolo = "y2", Nome = "y2", ValorPadrao = 6 } ],
    ...
    private void AdicionarLogicaMatematicaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "p", Nome = "p", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "q", Nome = "q", ValorPadrao = 0, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a1", Nome = "expoente 2", ValorPadrao = 3, ValorMin = 0 }, new() { Simbolo = "a2", Nome = "expoente 3", ValorPadrao = 2, ValorMin = 0 } ],
    ...
    private void AdicionarMateriaCondensadaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "hbar", Nome = "hbar", ValorPadrao = 1.054571817e-34 }, new() { Simbolo = "k", Nome = "k", ValorPadrao = 1e10 }, new() { Simbolo = "m", Nome = "m", ValorPadrao = 9.10938356e-31 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 8.5e28 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 1.602176634e-19 }, new() { Simbolo = "tau", Nome = "tau", ValorPadrao = 2.5e-14 }, new() { Simbolo = "m", Nome = "m", ValorPadrao = 9.10938356e-31 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "h", Nome = "h", ValorPadrao = 6.62607015e-34 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 1.602176634e-19 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "N", Nome = "N", ValorPadrao = 1 }, new() { Simbolo = "kB", Nome = "kB", ValorPadrao = 1.380649e-23 }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 20, ValorMin = 0.001 }, new() { Simbolo = "thetaD", Nome = "thetaD", ValorPadrao = 300, ValorMin = 0.001 } ],
    ...
    private void AdicionarCaosFractaisCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "r", Nome = "r", ValorPadrao = 3.9, ValorMin = 0, ValorMax = 4 }, new() { Simbolo = "x", Nome = "x_n", ValorPadrao = 0.4, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "delta0", Nome = "delta0", ValorPadrao = 1e-6, ValorMin = 0 }, new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = 0.9 }, new() { Simbolo = "t", Nome = "t", ValorPadrao = 5, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "N", Nome = "N", ValorPadrao = 2, ValorMin = 1.0001 }, new() { Simbolo = "r", Nome = "r", ValorPadrao = 1.0/3.0, ValorMin = 0.0001, ValorMax = 0.9999 } ],
    ...
    private void AdicionarFisicaPlasmasCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "eps0", Nome = "eps0", ValorPadrao = 8.8541878128e-12 }, new() { Simbolo = "kB", Nome = "kB", ValorPadrao = 1.380649e-23 }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 1e5, ValorMin = 1 }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1e18, ValorMin = 1 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 1.602176634e-19 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 1e18, ValorMin = 1 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 1.602176634e-19 }, new() { Simbolo = "eps0", Nome = "eps0", ValorPadrao = 8.8541878128e-12 }, new() { Simbolo = "me", Nome = "me", ValorPadrao = 9.10938356e-31 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "B", Nome = "B", ValorPadrao = 0.01, ValorMin = 0 }, new() { Simbolo = "mu0", Nome = "mu0", ValorPadrao = 4e-7 * Math.PI }, new() { Simbolo = "rho", Nome = "rho", ValorPadrao = 1e-6, ValorMin = 1e-12 } ],
    ...
    private void AdicionarFisicaNuclearCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "R0", Nome = "R0", ValorPadrao = 1.2, Unidade = "fm" }, new() { Simbolo = "A", Nome = "A", ValorPadrao = 56, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mi", Nome = "massa inicial", ValorPadrao = 1.0001 }, new() { Simbolo = "mf", Nome = "massa final", ValorPadrao = 1.0 }, new() { Simbolo = "c", Nome = "c", ValorPadrao = 299792458 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 1e-28 }, new() { Simbolo = "I", Nome = "fluxo I", ValorPadrao = 1e12 }, new() { Simbolo = "n", Nome = "densidade n", ValorPadrao = 1e24 }, new() { Simbolo = "L", Nome = "espessura L", ValorPadrao = 1e-3 } ],
    ...
    private void AdicionarOpticaQuanticaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "hbar", Nome = "hbar", ValorPadrao = 1.054571817e-34 }, new() { Simbolo = "omega", Nome = "omega", ValorPadrao = 3e15 }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "alpha", Nome = "|alpha|", ValorPadrao = 2, ValorMin = 0 } ],
    ...
    private void AdicionarAnaliseSobrevivenciaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "F", Nome = "F(t)", ValorPadrao = 0.3, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "S(t)", ValorPadrao = 0.2, ValorMin = 0.0001, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "beta", Nome = "beta", ValorPadrao = 0.69 } ],
    ...
    private void AdicionarValoresExtremosCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 10 }, new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 10 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 2, ValorMin = 0.001 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 0 }, new() { Simbolo = "z", Nome = "z_alpha", ValorPadrao = 2.326 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 0.01, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "u", Nome = "u", ValorPadrao = 0.5, ValorMin = 0.0001, ValorMax = 0.9999 }, new() { Simbolo = "v", Nome = "v", ValorPadrao = 0.7, ValorMin = 0.0001, ValorMax = 0.9999 }, new() { Simbolo = "theta", Nome = "theta", ValorPadrao = 2, ValorMin = 0.0001 } ],
    ...
    private void AdicionarGeoestatisticaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "var", Nome = "Var diff", ValorPadrao = 4, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "sigma2", Nome = "sigma^2", ValorPadrao = 9, ValorMin = 0 }, new() { Simbolo = "h", Nome = "h", ValorPadrao = 2, ValorMin = 0 }, new() { Simbolo = "a", Nome = "alcance", ValorPadrao = 3, ValorMin = 0.0001 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "l1", Nome = "lambda1", ValorPadrao = 0.2 }, new() { Simbolo = "l2", Nome = "lambda2", ValorPadrao = 0.3 }, new() { Simbolo = "l3", Nome = "lambda3", ValorPadrao = 0.5 }, new() { Simbolo = "z1", Nome = "Z1", ValorPadrao = 10 }, new() { Simbolo = "z2", Nome = "Z2", ValorPadrao = 12 }, new() { Simbolo = "z3", Nome = "Z3", ValorPadrao = 11 } ],
    ...
    private void AdicionarMecanicaFraturaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 100, ValorMin = 0 }, new() { Simbolo = "a", Nome = "a", ValorPadrao = 0.01, ValorMin = 0 }, new() { Simbolo = "F", Nome = "F", ValorPadrao = 1, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "C", Nome = "C", ValorPadrao = 1e-12, ValorMin = 0 }, new() { Simbolo = "DeltaK", Nome = "DeltaK", ValorPadrao = 20, ValorMin = 0 }, new() { Simbolo = "m", Nome = "m", ValorPadrao = 3, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "d1", Nome = "n1/N1", ValorPadrao = 0.3, ValorMin = 0 }, new() { Simbolo = "d2", Nome = "n2/N2", ValorPadrao = 0.8, ValorMin = 0 } ],
    ...
    private void AdicionarCFDTurbulenciaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "U", Nome = "U", ValorPadrao = 2 }, new() { Simbolo = "L", Nome = "L", ValorPadrao = 0.5 }, new() { Simbolo = "nu", Nome = "nu", ValorPadrao = 1e-6, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Cmu", Nome = "Cmu", ValorPadrao = 0.09, ValorMin = 0 }, new() { Simbolo = "k", Nome = "k", ValorPadrao = 0.5, ValorMin = 0 }, new() { Simbolo = "eps", Nome = "epsilon", ValorPadrao = 0.05, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "u", Nome = "u", ValorPadrao = 10 }, new() { Simbolo = "dt", Nome = "dt", ValorPadrao = 0.001 }, new() { Simbolo = "dx", Nome = "dx", ValorPadrao = 0.02, ValorMin = 1e-9 } ],
    ...
    private void AdicionarRoboticaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "l1", Nome = "l1", ValorPadrao = 1, ValorMin = 0 }, new() { Simbolo = "l2", Nome = "l2", ValorPadrao = 1, ValorMin = 0 }, new() { Simbolo = "q2", Nome = "q2", ValorPadrao = 1.0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Kp", Nome = "Kp", ValorPadrao = 100 }, new() { Simbolo = "Kv", Nome = "Kv", ValorPadrao = 20 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 0.1 }, new() { Simbolo = "edot", Nome = "edot", ValorPadrao = -0.05 } ],
    ...
    private void AdicionarSistemasPotenciaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "V", Nome = "V", ValorPadrao = 13800, Unidade = "V" }, new() { Simbolo = "Zth", Nome = "Zth", ValorPadrao = 0.5, ValorMin = 1e-9, Unidade = "ohm" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Pm", Nome = "Pm", ValorPadrao = 1.0 }, new() { Simbolo = "Pe", Nome = "Pe", ValorPadrao = 0.8 }, new() { Simbolo = "M", Nome = "M", ValorPadrao = 5, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "B", Nome = "B", ValorPadrao = 12 }, new() { Simbolo = "theta", Nome = "theta", ValorPadrao = 0.05 } ],
    ...
    private void AdicionarFinancasQuantitativasCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "w1", Nome = "w1", ValorPadrao = 0.6 }, new() { Simbolo = "mu1", Nome = "mu1", ValorPadrao = 0.10 }, new() { Simbolo = "w2", Nome = "w2", ValorPadrao = 0.4 }, new() { Simbolo = "mu2", Nome = "mu2", ValorPadrao = 0.05 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Rp", Nome = "Rp", ValorPadrao = 0.12 }, new() { Simbolo = "Rf", Nome = "Rf", ValorPadrao = 0.03 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 0.15, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Rf", Nome = "Rf", ValorPadrao = 0.03 }, new() { Simbolo = "beta", Nome = "beta", ValorPadrao = 1.2 }, new() { Simbolo = "Rm", Nome = "E[Rm]", ValorPadrao = 0.10 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "S", ValorPadrao = 100, ValorMin = 0.0001 }, new() { Simbolo = "K", Nome = "K", ValorPadrao = 100, ValorMin = 0.0001 }, new() { Simbolo = "r", Nome = "r", ValorPadrao = 0.05 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 0.2, ValorMin = 1e-9 }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                ExemploPratico = "mu=0,z=2.326,sigma=1% => 2.326%.",
                Variaveis = [ new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 0 }, new() { Simbolo = "z", Nome = "z", ValorPadrao = 2.326 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 0.01, ValorMin = 0 } ],
                VariavelResultado = "VaR", Calcular = v => v["mu"] + v["z"] * v["sigma"]
            },
        ]);
    }
    ...
    private void AdicionarPesquisaOperacionalCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "c1", Nome = "c1", ValorPadrao = 5 }, new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 4 }, new() { Simbolo = "c2", Nome = "c2", ValorPadrao = 3 }, new() { Simbolo = "x2", Nome = "x2", ValorPadrao = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = 4, ValorMin = 0 }, new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 5, ValorMin = 0.0001 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "L", Nome = "L", ValorPadrao = 20, ValorMin = 0 }, new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = 4, ValorMin = 0.0001 } ],
    ...
    private void AdicionarCienciasClimaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Omega", Nome = "Omega", ValorPadrao = 7.2921159e-5 }, new() { Simbolo = "phi", Nome = "phi (rad)", ValorPadrao = Math.PI / 4 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "S", ValorPadrao = 1361 }, new() { Simbolo = "alpha", Nome = "alpha", ValorPadrao = 0.3 }, new() { Simbolo = "eps", Nome = "eps", ValorPadrao = 1.0 }, new() { Simbolo = "sigmaSB", Nome = "sigma", ValorPadrao = 5.670374419e-8 }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 288, ValorMin = 1 }, new() { Simbolo = "C", Nome = "C", ValorPadrao = 1e8, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "F2x", Nome = "F2xCO2", ValorPadrao = 3.7 }, new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = -1.0 } ],
    ...
    private void AdicionarBioinformaticaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "diag", Nome = "F(i-1,j-1)", ValorPadrao = 5 }, new() { Simbolo = "s", Nome = "score", ValorPadrao = 2 }, new() { Simbolo = "up", Nome = "F(i-1,j)", ValorPadrao = 4 }, new() { Simbolo = "left", Nome = "F(i,j-1)", ValorPadrao = 3 }, new() { Simbolo = "gap", Nome = "gap", ValorPadrao = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "p", Nome = "p", ValorPadrao = 0.1, ValorMin = 0, ValorMax = 0.74 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x", Nome = "x_i", ValorPadrao = 0.3, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "fi", Nome = "f_i", ValorPadrao = 1.2 }, new() { Simbolo = "fbar", Nome = "f_bar", ValorPadrao = 1.0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "c1", Nome = "c1", ValorPadrao = 1 }, new() { Simbolo = "v1", Nome = "v1", ValorPadrao = 10 }, new() { Simbolo = "c2", Nome = "c2", ValorPadrao = 0.2 }, new() { Simbolo = "v2", Nome = "v2", ValorPadrao = 5 } ],
    ...
    private void AdicionarAcusticaCompleta()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "T", Nome = "T (C)", ValorPadrao = 20 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "prms", Nome = "p_rms", ValorPadrao = 0.2, ValorMin = 1e-12 }, new() { Simbolo = "pref", Nome = "p_ref", ValorPadrao = 20e-6, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "V", Nome = "V", ValorPadrao = 200, ValorMin = 0.001 }, new() { Simbolo = "A", Nome = "A absorcao", ValorPadrao = 40, ValorMin = 0.001 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "k", Nome = "k", ValorPadrao = 1000, ValorMin = 0.001 }, new() { Simbolo = "m", Nome = "m", ValorPadrao = 10, ValorMin = 0.001 } ],
    ...
    private void AdicionarVolume3Complementos()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nxpy", Nome = "||x+y||", ValorPadrao = 5, ValorMin = 0 }, new() { Simbolo = "nxmy", Nome = "||x-y||", ValorPadrao = 1, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a11", Nome = "a11", ValorPadrao = 2 }, new() { Simbolo = "a22", Nome = "a22", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "cardA", Nome = "|A|", ValorPadrao = 17, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lhs", Nome = "int liminf fn", ValorPadrao = 2 }, new() { Simbolo = "rhs", Nome = "liminf int fn", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "na", Nome = "|A|", ValorPadrao = 2, ValorMin = 0 }, new() { Simbolo = "nb", Nome = "|B|", ValorPadrao = 3, ValorMin = 0 }, new() { Simbolo = "nc", Nome = "|C|", ValorPadrao = 2, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "y", Nome = "y_n", ValorPadrao = 0 }, new() { Simbolo = "k1", Nome = "k1", ValorPadrao = 1 }, new() { Simbolo = "k2", Nome = "k2", ValorPadrao = 2 }, new() { Simbolo = "k3", Nome = "k3", ValorPadrao = 2 }, new() { Simbolo = "k4", Nome = "k4", ValorPadrao = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "rtr", Nome = "r^T r", ValorPadrao = 4, ValorMin = 0 }, new() { Simbolo = "dtAd", Nome = "d^T A d", ValorPadrao = 20, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 1 }, new() { Simbolo = "y1", Nome = "y1", ValorPadrao = 2, ValorMin = 1e-12 }, new() { Simbolo = "a", Nome = "a", ValorPadrao = -1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "s1", Nome = "sat1", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "s2", Nome = "sat2", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "s3", Nome = "sat3", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 1e22, ValorMin = 1 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 1.602176634e-19, ValorMin = 1e-30 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "m", Nome = "m", ValorPadrao = 9.10938356e-31 }, new() { Simbolo = "c", Nome = "c", ValorPadrao = 299792458 }, new() { Simbolo = "ns", Nome = "ns", ValorPadrao = 1e28, ValorMin = 1 }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 1.602176634e-19 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 1 }, new() { Simbolo = "x", Nome = "x", ValorPadrao = 0.5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "z0", Nome = "z0 (real)", ValorPadrao = 0 }, new() { Simbolo = "c", Nome = "c (real)", ValorPadrao = 0.3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu0", Nome = "mu0", ValorPadrao = 4e-7 * Math.PI }, new() { Simbolo = "p", Nome = "p", ValorPadrao = 100 }, new() { Simbolo = "B", Nome = "B", ValorPadrao = 0.01, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "B", Nome = "B", ValorPadrao = 492, ValorMin = 0 }, new() { Simbolo = "A", Nome = "A", ValorPadrao = 56, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 2, ValorMin = 0 }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 2, ValorMin = 0, ValorMax = 20 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = 0.1, ValorMin = 1e-9 }, new() { Simbolo = "gamma", Nome = "gamma", ValorPadrao = 1.5, ValorMin = 1e-9 }, new() { Simbolo = "t", Nome = "t", ValorPadrao = 5, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 0 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 0.01, ValorMin = 0 }, new() { Simbolo = "z", Nome = "z", ValorPadrao = 2.326 }, new() { Simbolo = "alpha", Nome = "alpha", ValorPadrao = 0.99, ValorMin = 0.5, ValorMax = 0.9999 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "g0", Nome = "gamma(0+)", ValorPadrao = 0.2, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "KI", Nome = "KI", ValorPadrao = 30, ValorMin = 0 }, new() { Simbolo = "nu", Nome = "nu", ValorPadrao = 0.3, ValorMin = 0, ValorMax = 0.49 }, new() { Simbolo = "E", Nome = "E", ValorPadrao = 210000, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nu", Nome = "nu", ValorPadrao = 1.5e-5, ValorMin = 1e-12 }, new() { Simbolo = "alpha", Nome = "alpha", ValorPadrao = 2.1e-5, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "l1", Nome = "l1", ValorPadrao = 1, ValorMin = 0 }, new() { Simbolo = "l2", Nome = "l2", ValorPadrao = 1, ValorMin = 0 }, new() { Simbolo = "q1", Nome = "q1", ValorPadrao = 0 }, new() { Simbolo = "q2", Nome = "q2", ValorPadrao = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Ep", Nome = "E'", ValorPadrao = 1.1 }, new() { Simbolo = "V", Nome = "V", ValorPadrao = 1.0 }, new() { Simbolo = "Xp", Nome = "X'", ValorPadrao = 0.6, ValorMin = 1e-9 }, new() { Simbolo = "delta", Nome = "delta", ValorPadrao = Math.PI / 6 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "S", ValorPadrao = 100, ValorMin = 1e-9 }, new() { Simbolo = "K", Nome = "K", ValorPadrao = 100, ValorMin = 1e-9 }, new() { Simbolo = "r", Nome = "r", ValorPadrao = 0.05 }, new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 0.2, ValorMin = 1e-9 }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "p1", Nome = "p1", ValorPadrao = 10 }, new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "p2", Nome = "p2", ValorPadrao = 7 }, new() { Simbolo = "x2", Nome = "x2", ValorPadrao = 0, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "rho", Nome = "rho", ValorPadrao = 1.2, ValorMin = 1e-9 }, new() { Simbolo = "f", Nome = "f", ValorPadrao = 1e-4, ValorMin = 1e-9 }, new() { Simbolo = "dpdy", Nome = "dp/dy", ValorPadrao = -0.1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "p", Nome = "p", ValorPadrao = 0.7, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "q", Nome = "q", ValorPadrao = 0.3, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "c", Nome = "c", ValorPadrao = 343, ValorMin = 1 }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1, ValorMin = 0 }, new() { Simbolo = "m", Nome = "m", ValorPadrao = 0, ValorMin = 0 }, new() { Simbolo = "p", Nome = "p", ValorPadrao = 0, ValorMin = 0 }, new() { Simbolo = "Lx", Nome = "Lx", ValorPadrao = 5, ValorMin = 1e-9 }, new() { Simbolo = "Ly", Nome = "Ly", ValorPadrao = 4, ValorMin = 1e-9 }, new() { Simbolo = "Lz", Nome = "Lz", ValorPadrao = 3, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Sprev", Nome = "S_prev", ValorPadrao = 0.8, ValorMin = 0, ValorMax = 1 }, new() { Simbolo = "d", Nome = "d", ValorPadrao = 2, ValorMin = 0 }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 10, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "d", Nome = "d", ValorPadrao = 1, ValorMin = 0 }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 20, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "OE", Nome = "O-E", ValorPadrao = 4 }, new() { Simbolo = "V", Nome = "V", ValorPadrao = 8, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "u", Nome = "u", ValorPadrao = 0.8, ValorMin = 1e-6, ValorMax = 0.999999 }, new() { Simbolo = "v", Nome = "v", ValorPadrao = 0.9, ValorMin = 1e-6, ValorMax = 0.999999 }, new() { Simbolo = "theta", Nome = "theta", ValorPadrao = 2, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "term", Nome = "gamma0^T lambda", ValorPadrao = 0.7 }, new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 0.1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "sigmaa", Nome = "sigma_a", ValorPadrao = 160 }, new() { Simbolo = "Se", Nome = "Se", ValorPadrao = 400, ValorMin = 1e-9 }, new() { Simbolo = "sigmam", Nome = "sigma_m", ValorPadrao = 120 }, new() { Simbolo = "Su", Nome = "Su", ValorPadrao = 800, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "h", Nome = "h", ValorPadrao = 50 }, new() { Simbolo = "L", Nome = "L", ValorPadrao = 0.1 }, new() { Simbolo = "k", Nome = "k", ValorPadrao = 0.6, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "detJ", Nome = "detJ", ValorPadrao = 1e-8 }, new() { Simbolo = "eps", Nome = "eps", ValorPadrao = 1e-6, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x", Nome = "x_old", ValorPadrao = 0.1 }, new() { Simbolo = "f", Nome = "mismatch", ValorPadrao = 0.02 }, new() { Simbolo = "J", Nome = "Jacobiano", ValorPadrao = 0.5, ValorMin = 1e-12 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "S", ValorPadrao = 100 }, new() { Simbolo = "K", Nome = "K", ValorPadrao = 100 }, new() { Simbolo = "r", Nome = "r", ValorPadrao = 0.05 }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Rf", Nome = "Rf", ValorPadrao = 0.03 }, new() { Simbolo = "b1", Nome = "beta1", ValorPadrao = 1.2 }, new() { Simbolo = "l1", Nome = "lambda1", ValorPadrao = 0.04 }, new() { Simbolo = "b2", Nome = "beta2", ValorPadrao = 0.5 }, new() { Simbolo = "l2", Nome = "lambda2", ValorPadrao = 0.02 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "beta", Nome = "beta", ValorPadrao = 2e-11 }, new() { Simbolo = "k", Nome = "k", ValorPadrao = 1e-6 }, new() { Simbolo = "l", Nome = "l", ValorPadrao = 0.5e-6 }, new() { Simbolo = "R", Nome = "R", ValorPadrao = 1e6, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "b", Nome = "b", ValorPadrao = 0.3 }, new() { Simbolo = "T", Nome = "T(t)", ValorPadrao = 1 }, new() { Simbolo = "c", Nome = "c", ValorPadrao = 0.2 }, new() { Simbolo = "Tlag", Nome = "T(t-tau)", ValorPadrao = 0.6 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "cov", Nome = "Cov(w,z)", ValorPadrao = 0.12 }, new() { Simbolo = "wbar", Nome = "wbar", ValorPadrao = 1.5, ValorMin = 1e-9 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "prms", Nome = "prms", ValorPadrao = 0.2 }, new() { Simbolo = "rho", Nome = "rho", ValorPadrao = 1.2, ValorMin = 1e-9 }, new() { Simbolo = "c", Nome = "c", ValorPadrao = 343, ValorMin = 1e-9 } ],
