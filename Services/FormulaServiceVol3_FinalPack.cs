    ...
    private void AdicionarVolume3FechamentoTotal()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nf", Nome = "||f||p", ValorPadrao = 2.5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ng", Nome = "||g||q", ValorPadrao = 4.0, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nf", Nome = "||f||p", ValorPadrao = 3, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ng", Nome = "||g||p", ValorPadrao = 5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "cota", Calcular = v => v["nf"] + v["ng"],
                Unidades = "",
            },
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "c1", Nome = "coef 1", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "c2", Nome = "coef 2", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "c3", Nome = "coef 3", ValorPadrao = 12, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "muAn", Nome = "mu(An)", ValorPadrao = 2.01, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "muA", Nome = "mu(A)", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Ig", Nome = "int g", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Ih", Nome = "int h", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x1", Nome = "x1", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "x2", Nome = "x2", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "x3", Nome = "x3", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y1", Nome = "y1", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y2", Nome = "y2", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y3", Nome = "y3", ValorPadrao = 6, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "FA", Nome = "|F(A)|", ValorPadrao = 9, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "L", Nome = "(b-a)", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "h", Nome = "h", ValorPadrao = 0.1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "f2", Nome = "f''(xi)", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "L", Nome = "(b-a)", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "h", Nome = "h", ValorPadrao = 0.1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "f4", Nome = "f''''(xi)", ValorPadrao = 8, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "yn", Nome = "y_n", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "h", Nome = "h", ValorPadrao = 0.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "fn", Nome = "f_n", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "fn1", Nome = "f_{n-1}", ValorPadrao = 1.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "fn2", Nome = "f_{n-2}", ValorPadrao = 1.3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "fn3", Nome = "f_{n-3}", ValorPadrao = 1.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "df", Nome = "deg(f)", ValorPadrao = 3, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dg", Nome = "deg(g)", ValorPadrao = 4, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "bitsN", Nome = "log2(n)", ValorPadrao = 256, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "cons", Nome = "consistente", ValorPadrao = 1, ValorMin = 0, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "rica", Nome = "contendo aritmetica", ValorPadrao = 1, ValorMin = 0, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "hbar", Nome = "hbar", ValorPadrao = 1.054571817e-34, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "omegaD", Nome = "omegaD", ValorPadrao = 5e13, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kB", Nome = "kB", ValorPadrao = 1.380649e-23, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "N0V", Nome = "N(0)V", ValorPadrao = 0.3, ValorMin = 1e-6, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "N", Nome = "N", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kB", Nome = "kB", ValorPadrao = 1.380649e-23, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 30, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "thetaD", Nome = "thetaD", ValorPadrao = 300, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "I", Nome = "integral Debye", ValorPadrao = 6.49, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "l1", Nome = "lambda1", ValorPadrao = 0.9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l2", Nome = "lambda2", ValorPadrao = 0.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l3", Nome = "lambda3", ValorPadrao = -14.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 1e18, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "lambdaD", Nome = "lambdaD", ValorPadrao = 1e-4, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 1e-28, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "I", Nome = "I", ValorPadrao = 1e12, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1e24, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "L", Nome = "L", ValorPadrao = 1e-3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "g0", Nome = "g0", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nu", Nome = "nu", ValorPadrao = 100, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nu0", Nome = "nu0", ValorPadrao = 100, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "DeltaNu", Nome = "DeltaNu", ValorPadrao = 5, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "I", Nome = "I", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Isat", Nome = "Isat", ValorPadrao = 10, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = 0.1, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "gamma", Nome = "gamma", ValorPadrao = 2, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "t", Nome = "t", ValorPadrao = 5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "q", Nome = "quantil", ValorPadrao = 0.024, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "term", Nome = "gamma0^T lambda", ValorPadrao = 0.9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 0.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "ka", Nome = "ka", ValorPadrao = 0.8, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kb", Nome = "kb", ValorPadrao = 0.9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kc", Nome = "kc", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kd", Nome = "kd", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ke", Nome = "ke", ValorPadrao = 0.95, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Sep", Nome = "Se'", ValorPadrao = 300, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Cs", Nome = "Cs", ValorPadrao = 0.17, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Delta", Nome = "Delta", ValorPadrao = 0.02, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Sabs", Nome = "|S|", ValorPadrao = 100, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "M", Nome = "M", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "qdd", Nome = "qdd_d", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Kv", Nome = "Kv", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "edot", Nome = "edot", ValorPadrao = 0.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Kp", Nome = "Kp", ValorPadrao = 50, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "e", Nome = "e", ValorPadrao = 0.02, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "C", Nome = "C", ValorPadrao = 0.3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "G", Nome = "G", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "base", Nome = "MVAbase", ValorPadrao = 100, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Zpu", Nome = "Zpu", ValorPadrao = 0.2, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "S", ValorPadrao = 100, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "d1", Nome = "d1", ValorPadrao = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "l1", Nome = "perda1", ValorPadrao = 0.05, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l2", Nome = "perda2", ValorPadrao = 0.06, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l3", Nome = "perda3", ValorPadrao = 0.08, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "r1", Nome = "r1", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v1", Nome = "Vnext1", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r2", Nome = "r2", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v2", Nome = "Vnext2", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "gamma", Nome = "gamma", ValorPadrao = 0.9, ValorMin = 0, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lambda", Nome = "lambda", ValorPadrao = 0.8, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ES2", Nome = "E[S^2]", ValorPadrao = 3, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "rho", Nome = "rho", ValorPadrao = 0.6, ValorMin = 0, ValorMax = 0.999, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "F", Nome = "F2xCO2", ValorPadrao = 3.7, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Vmax", Nome = "Vmax", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Km", Nome = "Km", ValorPadrao = 2, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 2, ValorMin = 1e-9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "S", Nome = "S", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "I", Nome = "I", ValorPadrao = 1e-6, ValorMin = 1e-20, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Iref", Nome = "Iref", ValorPadrao = 1e-12, ValorMin = 1e-20, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "wn", Nome = "omega_n", ValorPadrao = 10, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "zeta", Nome = "zeta", ValorPadrao = 0.1, ValorMin = 0, ValorMax = 0.999, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
