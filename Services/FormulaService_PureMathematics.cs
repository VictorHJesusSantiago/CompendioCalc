    ...
    private void AdicionarAlgebraAbstrata()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [
                    new() { Simbolo = "a", Nome = "Base (a)", Descricao = "Elemento do grupo (numérico)", ValorPadrao = 2, Unidade = "adim" },
                    new() { Simbolo = "n", Nome = "Módulo (n)", Descricao = "Ordem do grupo cíclico ℤₙ", ValorPadrao = 7, ValorMin = 1, Unidade = "adim" },
                ],
            ...
            new Formula
            {
                ...
                AnoOrigin = "1770",
                Variaveis = [
                    new() { Simbolo = "G", Nome = "|G| (ordem do grupo)", ValorPadrao = 12, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "H", Nome = "|H| (ordem do subgrupo)", ValorPadrao = 4, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula
            {
                ...
                Criador = "Teoria de grupos clássica",
                Variaveis = [
                    new() { Simbolo = "G", Nome = "|G|", ValorPadrao = 12, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "H", Nome = "|H|", ValorPadrao = 4, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula
            {
                ...
                Variaveis = [
                    new() { Simbolo = "G", Nome = "|G|", ValorPadrao = 3, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "H", Nome = "|H|", ValorPadrao = 4, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
                VariavelResultado = "|G×H|",
                Calcular = vars => vars["G"] * vars["H"],
            ...
            new Formula
            {
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "q", Nome = "q", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "g", Nome = "g", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "f",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1830",
                Variaveis = [
                    new() { Simbolo = "p", Nome = "Primo p", ValorPadrao = 2, ValorMin = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "n", Nome = "Expoente n", ValorPadrao = 8, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula
            {
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "ℤ", Nome = "ℤ", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "pℤ", Nome = "pℤ", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Criador = "Emmy Noether",
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "rm", Nome = "rm", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "sm", Nome = "sm", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "m",
                UnidadeResultado = "",
    ...
    private void AdicionarTopologia()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "top_m02", Nome = "Distância Euclidiana", Categoria = "Topologia", SubCategoria = "Espaços Métricos",
                ...
                Variaveis = [
                    new() { Simbolo = "x1", Nome = "x₁", ValorPadrao = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y1", Nome = "y₁", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "x2", Nome = "x₂", ValorPadrao = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y2", Nome = "y₂", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula { Id = "top_m03", Nome = "Distância do Supremo d∞", Categoria = "Topologia", SubCategoria = "Espaços Métricos",
                ...
                Variaveis = [
                    new() { Simbolo = "x1", Nome = "x₁", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y1", Nome = "y₁", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "x2", Nome = "x₂", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y2", Nome = "y₂", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
                VariavelResultado = "d∞(x,y)",
            ...
            new Formula { Id = "top_m04", Nome = "Distância de Manhattan d₁", Categoria = "Topologia", SubCategoria = "Espaços Métricos",
                ...
                Variaveis = [
                    new() { Simbolo = "x1", Nome = "x₁", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y1", Nome = "y₁", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "x2", Nome = "x₂", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y2", Nome = "y₂", ValorPadrao = 6, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
                VariavelResultado = "d₁(x,y)",
            ...
            new Formula { Id = "top_p10", Nome = "Característica de Euler χ(X)", Categoria = "Topologia", SubCategoria = "Espaços Topológicos",
                ...
                Variaveis = [
                    new() { Simbolo = "V", Nome = "Vértices V", ValorPadrao = 8, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "E", Nome = "Arestas E", ValorPadrao = 12, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "F", Nome = "Faces F", ValorPadrao = 6, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula { Id = "top_p11", Nome = "χ de Superfícies", Categoria = "Topologia", SubCategoria = "Espaços Topológicos",
                ...
                Variaveis = [ new() { Simbolo = "g", Nome = "Gênero g", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "χ",
    ...
    private void AdicionarGeometriaDiferencial()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "gd_c02", Nome = "Curvatura κ", Categoria = "Geometria Diferencial", SubCategoria = "Curvas",
                ...
                Variaveis = [ new() { Simbolo = "R", Nome = "Raio R do círculo osculador", ValorPadrao = 5, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula { Id = "gd_c05", Nome = "Vetor Binormal B", Categoria = "Geometria Diferencial", SubCategoria = "Curvas",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "T", Nome = "T", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "N", Nome = "N", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "B",
                UnidadeResultado = "",
            ...
            new Formula { Id = "gd_s02", Nome = "Coeficientes da 1ª Forma Fundamental", Categoria = "Geometria Diferencial", SubCategoria = "Superfícies",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "rᵤ", Nome = "rᵤ", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "rᵤ", Nome = "rᵤ", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "E",
                UnidadeResultado = "",
            ...
            new Formula { Id = "gd_s06", Nome = "Coeficientes da 2ª Forma Fundamental", Categoria = "Geometria Diferencial", SubCategoria = "Superfícies",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "rᵤᵤ", Nome = "rᵤᵤ", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "e",
                UnidadeResultado = "",
            ...
            new Formula { Id = "gd_s09", Nome = "Curvatura de Gauss K", Categoria = "Geometria Diferencial", SubCategoria = "Superfícies",
                ...
                Variaveis = [
                    new() { Simbolo = "k1", Nome = "κ₁", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "k2", Nome = "κ₂", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
                VariavelResultado = "K",
            ...
            new Formula { Id = "gd_s10", Nome = "Curvatura Média H", Categoria = "Geometria Diferencial", SubCategoria = "Superfícies",
                ...
                Variaveis = [
                    new() { Simbolo = "k1", Nome = "κ₁", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "k2", Nome = "κ₂", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
                VariavelResultado = "H",
    ...
    private void AdicionarCalculoVariacoes()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "cv_02", Nome = "Condição de Extremo δJ=0", Categoria = "Cálculo de Variações", SubCategoria = "Funcional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "delta", Nome = "delta", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "J", Nome = "J", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_03", Nome = "Equação de Euler-Lagrange", Categoria = "Cálculo de Variações", SubCategoria = "Funcional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "L", Nome = "L", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y", Nome = "y", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_04", Nome = "Geodésica Plana (comprimento de arco)", Categoria = "Cálculo de Variações", SubCategoria = "Funcional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "ax", Nome = "ax", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "b", Nome = "b", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "y",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_07", Nome = "EL para Múltiplas Variáveis", Categoria = "Cálculo de Variações", SubCategoria = "Restrições",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "L", Nome = "L", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "d", Nome = "d", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_09", Nome = "Condição de Legendre", Categoria = "Cálculo de Variações", SubCategoria = "Restrições",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "y", Nome = "y", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_10", Nome = "Condição de Weierstrass", Categoria = "Cálculo de Variações", SubCategoria = "Restrições",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "E", Nome = "E", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "L", Nome = "L", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_13", Nome = "Equação de Lagrange (Mecânica)", Categoria = "Cálculo de Variações", SubCategoria = "Mecânica Variacional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "d", Nome = "d", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dt", Nome = "dt", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_14", Nome = "L = T - V", Categoria = "Cálculo de Variações", SubCategoria = "Mecânica Variacional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "T", Nome = "T", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "V", Nome = "V", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "L",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_15", Nome = "Hamiltoniano H (Legendre)", Categoria = "Cálculo de Variações", SubCategoria = "Mecânica Variacional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "H", Nome = "H", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "L", Nome = "L", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_16", Nome = "Equações de Hamilton", Categoria = "Cálculo de Variações", SubCategoria = "Mecânica Variacional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "q", Nome = "q", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "H", Nome = "H", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_17", Nome = "Colchete de Poisson", Categoria = "Cálculo de Variações", SubCategoria = "Mecânica Variacional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "f", Nome = "f", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "g", Nome = "g", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "cv_18", Nome = "Teorema de Noether", Categoria = "Cálculo de Variações", SubCategoria = "Mecânica Variacional",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "da", Nome = "da", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
    ...
    private void AdicionarFuncoesEspeciais()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "fe_sp01", Nome = "Função Gamma Γ(z)", Categoria = "Funções Especiais", SubCategoria = "Gamma e Beta",
                ...
                Variaveis = [ new() { Simbolo = "z", Nome = "z (argumento)", ValorPadrao = 5, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula { Id = "fe_sp02", Nome = "Γ(n+1) = n!", Categoria = "Funções Especiais", SubCategoria = "Gamma e Beta",
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "n!",
            ...
            new Formula { Id = "fe_sp03", Nome = "Recorrência Γ(z+1) = z·Γ(z)", Categoria = "Funções Especiais", SubCategoria = "Gamma e Beta",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "Gamma", Nome = "Gamma", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "z", Nome = "z", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_sp06", Nome = "Fórmula de Stirling", Categoria = "Funções Especiais", SubCategoria = "Gamma e Beta",
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 10, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula { Id = "fe_sp07", Nome = "Função Beta B(x,y)", Categoria = "Funções Especiais", SubCategoria = "Gamma e Beta",
                ...
                Variaveis = [
                    new() { Simbolo = "x", Nome = "x", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "y", Nome = "y", ValorPadrao = 3, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula { Id = "fe_sp08", Nome = "Simetria B(x,y) = B(y,x)", Categoria = "Funções Especiais", SubCategoria = "Gamma e Beta",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "B", Nome = "B", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_bs01", Nome = "Equação de Bessel", Categoria = "Funções Especiais", SubCategoria = "Bessel",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "xy", Nome = "xy", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nu", Nome = "nu", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_bs02", Nome = "Bessel 1ª Espécie Jᵥ(x)", Categoria = "Funções Especiais", SubCategoria = "Bessel",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nu", Nome = "nu", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_bs03", Nome = "J_{-n}(x) = (-1)ⁿJₙ(x)", Categoria = "Funções Especiais", SubCategoria = "Bessel",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "J", Nome = "J", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_lg01", Nome = "Equação de Legendre", Categoria = "Funções Especiais", SubCategoria = "Legendre",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "y", Nome = "y", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_lg03", Nome = "Primeiros Polinômios de Legendre", Categoria = "Funções Especiais", SubCategoria = "Legendre",
                ...
                Variaveis = [
                    new() { Simbolo = "x", Nome = "x", ValorPadrao = 0.5, ValorMin = -1, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "n", Nome = "n (0,1,2,3)", ValorPadrao = 2, ValorMin = 0, ValorMax = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula { Id = "fe_lg04", Nome = "Recorrência de Bonnet", Categoria = "Funções Especiais", SubCategoria = "Legendre",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_lg07", Nome = "Funções Associadas de Legendre", Categoria = "Funções Especiais", SubCategoria = "Legendre",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l", Nome = "l", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_lg08", Nome = "Harmônicos Esféricos Yₗᵐ", Categoria = "Funções Especiais", SubCategoria = "Legendre",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "theta", Nome = "theta", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "phi", Nome = "phi", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_hm03", Nome = "Primeiros Polinômios de Hermite", Categoria = "Funções Especiais", SubCategoria = "Hermite e Laguerre",
                ...
                Variaveis = [
                    new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "n", Nome = "n (0,1,2,3)", ValorPadrao = 2, ValorMin = 0, ValorMax = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
            ...
            new Formula { Id = "fe_la01", Nome = "Equação de Laguerre", Categoria = "Funções Especiais", SubCategoria = "Hermite e Laguerre",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "xy", Nome = "xy", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "fe_la03", Nome = "Primeiros Polinômios de Laguerre", Categoria = "Funções Especiais", SubCategoria = "Hermite e Laguerre",
                ...
                Variaveis = [
                    new() { Simbolo = "x", Nome = "x", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "n", Nome = "n (0,1,2)", ValorPadrao = 1, ValorMin = 0, ValorMax = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
    ...
    private void AdicionarAnaliseComplexa()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "ac_01", Nome = "Número Complexo z", Categoria = "Análise Complexa", SubCategoria = "Funções Analíticas",
                ...
                Variaveis = [
                    new() { Simbolo = "x", Nome = "Parte real x", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                    new() { Simbolo = "y", Nome = "Parte imaginária y", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" },
                ],
                VariavelResultado = "|z|",
            ...
            new Formula { Id = "ac_18", Nome = "Teorema dos Resíduos", Categoria = "Análise Complexa", SubCategoria = "Resíduos",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "2πi", Nome = "2πi", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Σₖ", Nome = "Σₖ", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula { Id = "ac_19", Nome = "Integral Real via Resíduos", Categoria = "Análise Complexa", SubCategoria = "Resíduos",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "2πi", Nome = "2πi", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Σ", Nome = "Σ", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
