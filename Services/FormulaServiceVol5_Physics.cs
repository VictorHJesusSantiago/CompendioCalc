    ...
    private void AdicionarMecanicaCeleste()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "H0", Nome = "Parte integrável H0(I)", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "eps", Nome = "Perturbação ε", ValorPadrao = 0.02, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "H1", Nome = "Termo perturbativo H1(I,θ,t)", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "H",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "eps", Nome = "Perturbação ε", ValorPadrao = 0.01, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dH1dTheta", Nome = "Derivada ∂H1/∂θ", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "omega1", Nome = "Componente ω1", ValorPadrao = 1.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "omega2", Nome = "Componente ω2", ValorPadrao = 2.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "k1", Nome = "Inteiro k1", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "k2", Nome = "Inteiro k2", ValorPadrao = -1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "omegaDotK", Nome = "|ω·k|", ValorPadrao = 0.30, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "gamma", Nome = "γ", ValorPadrao = 0.5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kNorm", Nome = "|k|", ValorPadrao = 3, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "tau", Nome = "τ", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "eps", Nome = "Perturbação ε", ValorPadrao = 0.005, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "epsCrit", Nome = "Limiar ε_crit", ValorPadrao = 0.02, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "G", Nome = "Constante gravitacional G (normalizada)", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m1", Nome = "Massa m1", ValorPadrao = 1, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m2", Nome = "Massa m2", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m3", Nome = "Massa m3", ValorPadrao = 3, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v1", Nome = "Velocidade v1", ValorPadrao = 1.0, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v2", Nome = "Velocidade v2", ValorPadrao = 0.8, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v3", Nome = "Velocidade v3", ValorPadrao = 0.5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r12", Nome = "Distância r12", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r13", Nome = "Distância r13", ValorPadrao = 3, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r23", Nome = "Distância r23", ValorPadrao = 2.5, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "coef", Nome = "Coeficiente no expoente", ValorPadrao = 8, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "escala", Nome = "Escala decimal", ValorPadrao = 1000000, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "aJ", Nome = "Semi-eixo de Júpiter (AU)", ValorPadrao = 5.2, ValorMin = 0.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "aAst", Nome = "Semi-eixo do asteroide (AU)", ValorPadrao = 2.5, ValorMin = 0.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "Semi-eixo maior a", ValorPadrao = 1, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "e", Nome = "Excentricidade e", ValorPadrao = 0.2, ValorMin = 0, ValorMax = 0.999, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nuDeg", Nome = "Anomalia verdadeira ν (graus)", ValorPadrao = 60, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "r",
                UnidadeResultado = "",
                Calcular = v => {
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu", Nome = "Parâmetro gravitacional μ", ValorPadrao = 398600, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r", Nome = "Raio r", ValorPadrao = 6378, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mu", Nome = "Parâmetro gravitacional μ", ValorPadrao = 398600, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r1", Nome = "Raio órbita inicial r1", ValorPadrao = 7000, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "r2", Nome = "Raio órbita final r2", ValorPadrao = 42164, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "FR", Nome = "Componente radial FR", ValorPadrao = 1e-6, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "FS", Nome = "Componente transversal FS", ValorPadrao = 2e-6, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "FW", Nome = "Componente normal FW", ValorPadrao = 0.5e-6, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "m1", Nome = "Massa principal m1", ValorPadrao = 1047, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m2", Nome = "Massa secundária m2", ValorPadrao = 1, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
    ...
    private void AdicionarMagnetismoMateriaMole()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "NmuB", Nome = "Fator NμB", ValorPadrao = 2.0, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "J", Nome = "Momento total J", ValorPadrao = 0.5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "BJ", Nome = "Função de Brillouin BJ", ValorPadrao = 0.8, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "M",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "H", Nome = "Campo externo H", ValorPadrao = 0.3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "lambda", Nome = "Acoplamento λ", ValorPadrao = 1.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "M", Nome = "Magnetização M", ValorPadrao = 0.4, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "C", Nome = "Constante de Curie C", ValorPadrao = 1.5, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "T", Nome = "Temperatura T", ValorPadrao = 320, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Tc", Nome = "Temperatura de Curie Tc", ValorPadrao = 300, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "χ",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "J", Nome = "Constante de troca J", ValorPadrao = 1.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Sdot", Nome = "Produto escalar S1·S2", ValorPadrao = 0.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "J", Nome = "Acoplamento J", ValorPadrao = 1.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "S", Nome = "Spin S", ValorPadrao = 0.5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ka", Nome = "Produto ka", ValorPadrao = 1.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Tc", Nome = "Temperatura crítica Tc", ValorPadrao = 300, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "T", Nome = "Temperatura T", ValorPadrao = 295, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "beta", Nome = "Expoente β", ValorPadrao = 0.326, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "J", Nome = "Interação de troca J", ValorPadrao = 0.9, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "rhoEF", Nome = "Densidade de estados ρ(EF)", ValorPadrao = 1.4, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Ic", Nome = "Corrente crítica Ic", ValorPadrao = 10, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "phiDeg", Nome = "Fase φ (graus)", ValorPadrao = 30, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "I",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "V_uV", Nome = "Tensão V (μV)", ValorPadrao = 5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Ic0", Nome = "Corrente crítica de cada junção Ic0", ValorPadrao = 8, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "phiOverPhi0", Nome = "Razão Φ/Φ0", ValorPadrao = 0.25, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "N", Nome = "Número de elos N", ValorPadrao = 1000, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "b", Nome = "Comprimento do elo b", ValorPadrao = 0.5, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "N", Nome = "Número de monômeros N", ValorPadrao = 1000, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nu", Nome = "Expoente de Flory ν", ValorPadrao = 0.588, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "xi", Nome = "Coeficiente de atrito ξ", ValorPadrao = 1, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "b", Nome = "Comprimento b", ValorPadrao = 0.5, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "N", Nome = "Número de elos N", ValorPadrao = 200, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "T", Nome = "Temperatura T", ValorPadrao = 300, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "p", Nome = "Modo p", ValorPadrao = 1, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "D0", Nome = "Constante D0", ValorPadrao = 1e-9, ValorMin = 1e-15, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "N", Nome = "Grau de polimerização N", ValorPadrao = 100, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "D",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "K1", Nome = "Constante K1 (splay)", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "K2", Nome = "Constante K2 (twist)", ValorPadrao = 8, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "K3", Nome = "Constante K3 (bend)", ValorPadrao = 12, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "splay", Nome = "(∇·n)", ValorPadrao = 0.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "twist", Nome = "(n·∇×n)", ValorPadrao = 0.15, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "bend", Nome = "|n×∇×n|", ValorPadrao = 0.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "V", Nome = "Volume efetivo", ValorPadrao = 1, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "F",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "S", Nome = "Parâmetro de ordem orientacional S", ValorPadrao = 0.65, ValorMin = 0, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "S",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "L", Nome = "Comprimento L do bastão", ValorPadrao = 100, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "D", Nome = "Diâmetro D do bastão", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
    ...
    private void AdicionarCristalografia()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nRedes", Nome = "Número de redes de Bravais", ValorPadrao = 14, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "nSistemas", Nome = "Número de sistemas cristalinos", ValorPadrao = 7, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Nclass", Nome = "Quantidade em uma classe/subconjunto", ValorPadrao = 46, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Ntotal", Nome = "Total de grupos espaciais", ValorPadrao = 230, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "Parâmetro de rede a", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "|b|",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "h", Nome = "Índice de Miller h", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "k", Nome = "Índice de Miller k", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l", Nome = "Índice de Miller l", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "a", Nome = "Parâmetro de rede a", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "G",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "d", Nome = "Espaçamento interplanar d", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "thetaDeg", Nome = "Ângulo θ (graus)", ValorPadrao = 30, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "Ordem n", ValorPadrao = 1, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "λ",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "dKx", Nome = "Componente Δkx", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dKy", Nome = "Componente Δky", ValorPadrao = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dKz", Nome = "Componente Δkz", ValorPadrao = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "f1", Nome = "Fator atômico f1", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "f2", Nome = "Fator atômico f2", ValorPadrao = 8, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "phi1", Nome = "Fase φ1 (rad)", ValorPadrao = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "phi2", Nome = "Fase φ2 (rad)", ValorPadrao = 3.1415926535, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "h", Nome = "Índice h", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "k", Nome = "Índice k", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "l", Nome = "Índice l", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Fabs", Nome = "|F(hkl)|", ValorPadrao = 5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "LP", Nome = "Fator Lorentz-polarização", ValorPadrao = 0.8, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "A", Nome = "Fator de absorção", ValorPadrao = 0.9, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "B", Nome = "Parâmetro térmico B", ValorPadrao = 1.2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "thetaDeg", Nome = "Ângulo θ (graus)", ValorPadrao = 30, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "lambda", Nome = "Comprimento de onda λ", ValorPadrao = 1.54, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "f0", Nome = "Amplitude sem atenuação f0", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
