...
public partial class FormulaService
{
    ...
    private void AdicionarTeoriaLieRepresentacoes()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "x", Nome = "Elemento x da álgebra", ValorPadrao = 1 }, new() { Simbolo = "y", Nome = "Elemento y", ValorPadrao = 2 }, new() { Simbolo = "z", Nome = "Elemento z", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "adx", Nome = "ad(x) operador adjunto", ValorPadrao = 2 }, new() { Simbolo = "ady", Nome = "ad(y) operador adjunto", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "detB", Nome = "Determinante da forma de Killing", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "n (para sl(n) ou outro tipo)", ValorPadrao = 4, ValorMin = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "dimh", Nome = "dim(h) = rank", ValorPadrao = 2 }, new() { Simbolo = "numRaizes", Nome = "Número de raízes (pares ±α)", ValorPadrao = 6 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "alpha", Nome = "Raiz α (norma ao quadrado)", ValorPadrao = 2 }, new() { Simbolo = "beta", Nome = "Raiz β (norma ao quadrado)", ValorPadrao = 2 }, new() { Simbolo = "alphaBeta", Nome = "(α,β) produto escalar", ValorPadrao = -1 } ],
            ...
            },            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "r", Nome = "rank(g)", ValorPadrao = 2, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "alphai", Nome = "α_i (componente)", ValorPadrao = 1 }, new() { Simbolo = "alphaj", Nome = "α_j", ValorPadrao = 1 }, new() { Simbolo = "alphajSq", Nome = "(α_j,α_j)", ValorPadrao = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "tipo", Nome = "Tipo (1=A,2=B,3=C,4=D,9=E₈)", ValorPadrao = 1, ValorMin = 1, ValorMax = 9 }, new() { Simbolo = "n", Nome = "Parâmetro n", ValorPadrao = 4, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "H", Nome = "Elemento H (Cartan)", ValorPadrao = 1 }, new() { Simbolo = "E", Nome = "Elemento E (raising)", ValorPadrao = 0.5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lambda", Nome = "Peso λ", ValorPadrao = 5 }, new() { Simbolo = "inner", Nome = "⟨λ,α⟩", ValorPadrao = 2 }, new() { Simbolo = "alpha", Nome = "Raiz α", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "lambdaRho", Nome = "⟨λ+ρ,α⟩ médio", ValorPadrao = 3 }, new() { Simbolo = "rhoAlpha", Nome = "⟨ρ,α⟩ médio", ValorPadrao = 1 }, new() { Simbolo = "nRaizes", Nome = "Número de raízes positivas", ValorPadrao = 3, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "rhog", Nome = "ρ(g) (escalar repr.)", ValorPadrao = 2 }, new() { Simbolo = "rhoh", Nome = "ρ(h)", ValorPadrao = 3 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "rhog", Nome = "tr(ρ(g)) (traço da matriz)", ValorPadrao = -1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mesmaRep", Nome = "ρ=σ? (1=sim, 0=não)", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "dim1", Nome = "dim(ρ₁)", ValorPadrao = 1 }, new() { Simbolo = "dim2", Nome = "dim(ρ₂)", ValorPadrao = 1 }, new() { Simbolo = "dim3", Nome = "dim(ρ₃)", ValorPadrao = 2 } ],
                VariavelResultado = "|G|",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mesmaRep", Nome = "V≅W irredutíveis? (1=sim, 0=não)", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "m1", Nome = "Multiplicidade m₁", ValorPadrao = 1 }, new() { Simbolo = "dim1", Nome = "dim(V₁)", ValorPadrao = 1 }, new() { Simbolo = "m2", Nome = "Multiplicidade m₂", ValorPadrao = 2 }, new() { Simbolo = "dim2", Nome = "dim(V₂)", ValorPadrao = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "mult", Nome = "Multiplicidade", ValorPadrao = 1, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "nIrreps", Nome = "Número de irreps (truncamento)", ValorPadrao = 5 }, new() { Simbolo = "dimMedia", Nome = "dim média", ValorPadrao = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "f1", Nome = "f(g₁)", ValorPadrao = 2 }, new() { Simbolo = "rho1", Nome = "tr(ρ(g₁))", ValorPadrao = 3 }, new() { Simbolo = "f2", Nome = "f(g₂)", ValorPadrao = 1 }, new() { Simbolo = "rho2", Nome = "tr(ρ(g₂))", ValorPadrao = 4 } ],
    ...
    private void AdicionarTeoriaNumeros()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "[K:ℚ] grau da extensão", ValorPadrao = 2, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "d", Nome = "d em K=ℚ(√d)", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "e1", Nome = "Expoente e₁", ValorPadrao = 2 }, new() { Simbolo = "e2", Nome = "Expoente e₂", ValorPadrao = 1 }, new() { Simbolo = "e3", Nome = "Expoente e₃ (0 se ausente)", ValorPadrao = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "e", Nome = "Índice de ramificação e", ValorPadrao = 2, ValorMin = 1 }, new() { Simbolo = "f", Nome = "Grau residual f", ValorPadrao = 1, ValorMin = 1 }, new() { Simbolo = "g", Nome = "Número de primos g", ValorPadrao = 1, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "hK", Nome = "Número de classes h_K", ValorPadrao = 2, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "[K:ℚ]", ValorPadrao = 2, ValorMin = 1 }, new() { Simbolo = "r2", Nome = "r₂ pares complexos", ValorPadrao = 1, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "r1", Nome = "r₁ emersões reais", ValorPadrao = 2, ValorMin = 0 }, new() { Simbolo = "r2", Nome = "r₂ pares complexos", ValorPadrao = 0, ValorMin = 0 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "Parte 'a' de a+b√d", ValorPadrao = 2 }, new() { Simbolo = "b", Nome = "Coeficiente 'b'", ValorPadrao = 1 }, new() { Simbolo = "d", Nome = "√d", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "Parte 'a' de a+b√d", ValorPadrao = 2 }, new() { Simbolo = "b", Nome = "Coef 'b' (cancela)", ValorPadrao = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "p", Nome = "Primo ímpar p", ValorPadrao = 3 }, new() { Simbolo = "q", Nome = "Primo ímpar q", ValorPadrao = 5 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "Inteiro a", ValorPadrao = 2 }, new() { Simbolo = "p", Nome = "Primo ímpar p", ValorPadrao = 7 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "a", Nome = "Inteiro a", ValorPadrao = 2 }, new() { Simbolo = "legendre1", Nome = "(a/p₁) Legendre 1", ValorPadrao = -1 }, new() { Simbolo = "legendre2", Nome = "(a/p₂) Legendre 2", ValorPadrao = -1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "[L:K] grau da extensão abeliana", ValorPadrao = 4, ValorMin = 1 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "Np", Nome = "Norma do primo Np", ValorPadrao = 5 }, new() { Simbolo = "x", Nome = "Elemento x no corpo", ValorPadrao = 2 } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "dimH1", Nome = "dim H¹ estimada", ValorPadrao = 2, ValorMin = 0 } ],
    ...
    {
        _formulas.AddRange([
            new Formula { Id = "5_gr01", Nome = "Curvatura Seccional", Categoria = "Geometria Riemanniana", SubCategoria = "Curvaturas", Expressao = "K(σ)=R(X,Y,Y,X)/(||X||²||Y||²-<X,Y>²)", ExprTexto = "K = R/denominador", Icone = "K", Descricao = "Curvatura da 2-seção σ gerada por X,Y. Mede desvio local de geodésicas.", Variaveis = [ new() { Simbolo = "R", Nome = "R(X,Y,Y,X)", ValorPadrao = 1 }, new() { Simbolo = "x2", Nome = "||X||²", ValorPadrao = 1 }, new() { Simbolo = "y2", Nome = "||Y||²", ValorPadrao = 1 }, new() { Simbolo = "xy", Nome = "<X,Y>", ValorPadrao = 0 } ], VariavelResultado = "K(σ)", UnidadeResultado = "", Calcular = v => v["R"] / Math.Max(1e-9, (v["x2"] * v["y2"] - v["xy"] * v["xy"])) },
            new Formula { Id = "5_gr02", Nome = "Curvatura de Ricci", Categoria = "Geometria Riemanniana", SubCategoria = "Curvaturas", Expressao = "Ric(X,X)=Σ_i K(X,e_i)", ExprTexto = "Ric = soma das seccionais", Icone = "Ric", Descricao = "Contração do tensor de Riemann. Controla volume e convergência geodésica.", Variaveis = [ new() { Simbolo = "k1", Nome = "K(X,e1)", ValorPadrao = 1 }, new() { Simbolo = "k2", Nome = "K(X,e2)", ValorPadrao = 1 }, new() { Simbolo = "k3", Nome = "K(X,e3)", ValorPadrao = 1 } ], VariavelResultado = "Ric(X,X)", UnidadeResultado = "", Calcular = v => v["k1"] + v["k2"] + v["k3"] },
            new Formula { Id = "5_gr03", Nome = "Curvatura Escalar", Categoria = "Geometria Riemanniana", SubCategoria = "Curvaturas", Expressao = "R=tr(Ric)", ExprTexto = "R escalar = traço de Ric", Icone = "R", Descricao = "Soma dos autovalores de Ricci. Aparece na Relatividade e no fluxo de Ricci.", Variaveis = [ new() { Simbolo = "ric1", Nome = "Ric11", ValorPadrao = 1 }, new() { Simbolo = "ric2", Nome = "Ric22", ValorPadrao = 1 }, new() { Simbolo = "ric3", Nome = "Ric33", ValorPadrao = 1 } ], VariavelResultado = "R", UnidadeResultado = "", Calcular = v => v["ric1"] + v["ric2"] + v["ric3"] },
            new Formula { Id = "5_gr04", Nome = "Equação de Jacobi", Categoria = "Geometria Riemanniana", SubCategoria = "Geodésicas", Expressao = "D²J/dt² + R(J,γ')γ' = 0", ExprTexto = "J'' + RJ = 0", Icone = "J", Descricao = "Campos de Jacobi medem separação de geodésicas vizinhas.", Variaveis = [ new() { Simbolo = "jpp", Nome = "D²J/dt²", ValorPadrao = 1 }, new() { Simbolo = "rj", Nome = "R(J,γ')γ'", ValorPadrao = -1 } ], VariavelResultado = "Resíduo (deve ser 0)", UnidadeResultado = "", Calcular = v => v["jpp"] + v["rj"] },
            new Formula { Id = "5_gr05", Nome = "Bonnet-Myers (Cota de Diâmetro)", Categoria = "Geometria Riemanniana", SubCategoria = "Teoremas Globais", Expressao = "Ric≥(n-1)κ>0 => diam≤π/√κ", ExprTexto = "diam <= pi/sqrt(kappa)", Icone = "diam", Descricao = "Ricci positiva implica compacidade e grupo fundamental finito.", Variaveis = [ new() { Simbolo = "kappa", Nome = "κ", ValorPadrao = 1, ValorMin = 0.0001 } ], VariavelResultado = "Cota superior do diâmetro", UnidadeResultado = "", Calcular = v => Math.PI / Math.Sqrt(v["kappa"]) },
            new Formula { Id = "5_gr06", Nome = "Comparação de Bishop (Volume)", Categoria = "Geometria Riemanniana", SubCategoria = "Teoremas Globais", Expressao = "vol(B_r(p))<=vol_κ(B_r)", ExprTexto = "volume real <= volume modelo", Icone = "vol", Descricao = "Compara crescimento de volume sob hipóteses de curvatura.", Variaveis = [ new() { Simbolo = "volReal", Nome = "vol(B_r(p))", ValorPadrao = 8 }, new() { Simbolo = "volModelo", Nome = "vol_κ(B_r)", ValorPadrao = 10 } ], VariavelResultado = "Razão volReal/volModelo", UnidadeResultado = "", Calcular = v => v["volReal"] / Math.Max(1e-9, v["volModelo"]) },
            new Formula { Id = "5_gr07", Nome = "Hadamard-Cartan", Categoria = "Geometria Riemanniana", SubCategoria = "Teoremas Globais", Expressao = "K<=0 => exp_p: T_pM->M difeomorfismo", ExprTexto = "curvatura nao-positiva implica sem conjugados", Icone = "exp", Descricao = "Em variedades simplesmente conexas com K<=0, exponencial é difeomorfismo global.", Variaveis = [ new() { Simbolo = "k", Nome = "Curvatura máxima", ValorPadrao = -0.1 } ], VariavelResultado = "Condição satisfeita? 1/0", UnidadeResultado = "", Calcular = v => v["k"] <= 0 ? 1 : 0 },
            new Formula { Id = "5_gr08", Nome = "Tensor de Weyl (Modelo)", Categoria = "Geometria Riemanniana", SubCategoria = "Curvaturas", Expressao = "C=Riemann - termos de Ricci - termo escalar", ExprTexto = "C = parte conforme da curvatura", Icone = "C", Descricao = "Componente livre de traço do tensor de curvatura.", Variaveis = [ new() { Simbolo = "riem", Nome = "Componente de Riemann", ValorPadrao = 5 }, new() { Simbolo = "ricTerm", Nome = "Termo de Ricci", ValorPadrao = 2 }, new() { Simbolo = "escTerm", Nome = "Termo escalar", ValorPadrao = 1 } ], VariavelResultado = "Componente de Weyl", UnidadeResultado = "", Calcular = v => v["riem"] - v["ricTerm"] - v["escTerm"] },
            new Formula { Id = "5_gr09", Nome = "Variedade Einstein", Categoria = "Geometria Riemanniana", SubCategoria = "Estruturas Especiais", Expressao = "Ric=λg", ExprTexto = "Ric proporcional à métrica", Icone = "Ein", Descricao = "Condição de Einstein: curvatura de Ricci isotrópica.", Variaveis = [ new() { Simbolo = "lambda", Nome = "λ", ValorPadrao = 1 }, new() { Simbolo = "g", Nome = "Componente g", ValorPadrao = 2 }, new() { Simbolo = "ric", Nome = "Componente Ric", ValorPadrao = 2 } ], VariavelResultado = "Resíduo Ric-λg", UnidadeResultado = "", Calcular = v => v["ric"] - v["lambda"] * v["g"] },
            new Formula { Id = "5_gr10", Nome = "Fluxo de Ricci", Categoria = "Geometria Riemanniana", SubCategoria = "Evolução Geométrica", Expressao = "∂g_ij/∂t=-2R_ij", ExprTexto = "g_t = -2 Ric", Icone = "flow", Descricao = "Fluxo geométrico usado por Perelman na conjectura de Poincaré.", Variaveis = [ new() { Simbolo = "rij", Nome = "R_ij", ValorPadrao = 1 } ], VariavelResultado = "∂g_ij/∂t", UnidadeResultado = "", Calcular = v => -2 * v["rij"] },

            new Formula { Id = "5_th01", Nome = "Operador de Hodge *", Categoria = "Teoria de Hodge", SubCategoria = "Operadores", Expressao = "*:Ω^k->Ω^{n-k}; **ω=(-1)^{k(n-k)}ω", ExprTexto = "*^2 = (-1)^{k(n-k)}", Icone = "*", Descricao = "Dualidade de Hodge entre k-formas e (n-k)-formas.", Variaveis = [ new() { Simbolo = "k", Nome = "Grau k", ValorPadrao = 1 }, new() { Simbolo = "n", Nome = "Dimensão n", ValorPadrao = 4 } ], VariavelResultado = "Sinal de **", UnidadeResultado = "", Calcular = v => (((int)(v["k"] * (v["n"] - v["k"]))) % 2 == 0) ? 1 : -1 },
            new Formula { Id = "5_th02", Nome = "Coderivada δ", Categoria = "Teoria de Hodge", SubCategoria = "Operadores", Expressao = "δ=(-1)^{n(k+1)+1}*d*", ExprTexto = "delta por hodge star", Icone = "δ", Descricao = "Adjunto formal de d com métrica Riemanniana.", Variaveis = [ new() { Simbolo = "n", Nome = "n", ValorPadrao = 4 }, new() { Simbolo = "k", Nome = "k", ValorPadrao = 1 } ], VariavelResultado = "Sinal prefatorial", UnidadeResultado = "", Calcular = v => (((int)(v["n"] * (v["k"] + 1) + 1)) % 2 == 0) ? 1 : -1 },
            new Formula { Id = "5_th03", Nome = "Laplaciano de Hodge", Categoria = "Teoria de Hodge", SubCategoria = "Operadores", Expressao = "Δ=dδ+δd", ExprTexto = "Laplaciano em formas", Icone = "Δ", Descricao = "Forma é harmônica se Δω=0.", Variaveis = [ new() { Simbolo = "dδ", Nome = "dδ(ω)", ValorPadrao = 1 }, new() { Simbolo = "δd", Nome = "δd(ω)", ValorPadrao = -1 } ], VariavelResultado = "Δω", UnidadeResultado = "", Calcular = v => v["dδ"] + v["δd"] },
            new Formula { Id = "5_th04", Nome = "Decomposição de Hodge", Categoria = "Teoria de Hodge", SubCategoria = "Estrutura", Expressao = "Ω^k=H^k⊕dΩ^{k-1}⊕δΩ^{k+1}", ExprTexto = "dim Ω = dim H + dim exata + dim coexata", Icone = "⊕", Descricao = "Decomposição ortogonal em parcela harmônica, exata e coexata.", Variaveis = [ new() { Simbolo = "h", Nome = "dim H^k", ValorPadrao = 2 }, new() { Simbolo = "ex", Nome = "dim dΩ", ValorPadrao = 3 }, new() { Simbolo = "coex", Nome = "dim δΩ", ValorPadrao = 1 } ], VariavelResultado = "dim Ω^k", UnidadeResultado = "", Calcular = v => v["h"] + v["ex"] + v["coex"] },
            new Formula { Id = "5_th05", Nome = "Isomorfismo Hodge-de Rham", Categoria = "Teoria de Hodge", SubCategoria = "Cohomologia", Expressao = "H^k(harmônicas)≅H^k_dR(M)", ExprTexto = "b_k = dim H^k", Icone = "H^k", Descricao = "Toda classe de de Rham possui representante harmônico único em variedade compacta orientada.", Variaveis = [ new() { Simbolo = "bk", Nome = "Número de Betti b_k", ValorPadrao = 1, ValorMin = 0 } ], VariavelResultado = "dim H^k", UnidadeResultado = "", Calcular = v => v["bk"] },
            new Formula { Id = "5_th06", Nome = "Identidades de Kähler", Categoria = "Teoria de Hodge", SubCategoria = "Variedades Kähler", Expressao = "Δ=2Δ_dbar=2Δ_d", ExprTexto = "laplacianos coincidem em Kähler", Icone = "Kah", Descricao = "Estrutura complexa e simplética compatíveis simplificam análise harmônica.", Variaveis = [ new() { Simbolo = "dbar", Nome = "Δ_dbar", ValorPadrao = 2 }, new() { Simbolo = "d", Nome = "Δ_d", ValorPadrao = 2 } ], VariavelResultado = "Δ (médio)", UnidadeResultado = "", Calcular = v => (2 * v["dbar"] + 2 * v["d"]) / 2 },
            new Formula { Id = "5_th07", Nome = "Lema ∂∂̄", Categoria = "Teoria de Hodge", SubCategoria = "Variedades Kähler", Expressao = "d-fechada e d-exata <=> ∂∂̄-exata", ExprTexto = "equivalencia especial em Kähler", Icone = "ddbar", Descricao = "Ferramenta central para degenerescência de sequências espectrais e geometria complexa.", Variaveis = [ new() { Simbolo = "k", Nome = "Satisfaz hipótese? (1/0)", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 } ], VariavelResultado = "Válido? 1/0", UnidadeResultado = "", Calcular = v => v["k"] }
        ]);
    }
    ...
    {
        _formulas.AddRange([
            new Formula { Id = "5_ah01", Nome = "Medida de Haar", Categoria = "Análise Harmônica", SubCategoria = "Grupos Localmente Compactos", Expressao = "μ(gE)=μ(E)", ExprTexto = "invariância à esquerda", Icone = "μ", Descricao = "Medida invariante por translação em grupos localmente compactos.", Variaveis = [ new() { Simbolo = "muE", Nome = "μ(E)", ValorPadrao = 3 } ], VariavelResultado = "μ(gE)", UnidadeResultado = "", Calcular = v => v["muE"] },
            new Formula { Id = "5_ah02", Nome = "Unicidade da Haar", Categoria = "Análise Harmônica", SubCategoria = "Grupos Localmente Compactos", Expressao = "μ'=cμ", ExprTexto = "duas Haar diferem por constante", Icone = "c", Descricao = "Toda medida de Haar é única a menos de fator positivo.", Variaveis = [ new() { Simbolo = "c", Nome = "Constante c", ValorPadrao = 2 }, new() { Simbolo = "mu", Nome = "μ(E)", ValorPadrao = 3 } ], VariavelResultado = "μ'(E)", UnidadeResultado = "", Calcular = v => v["c"] * v["mu"] },
            new Formula { Id = "5_ah03", Nome = "Função Modular", Categoria = "Análise Harmônica", SubCategoria = "Grupos Localmente Compactos", Expressao = "Δ(g)=dμ_right/dμ_left", ExprTexto = "unimodular se Δ≡1", Icone = "Δ", Descricao = "Compara medidas à direita e à esquerda. Grupos compactos são unimodulares.", Variaveis = [ new() { Simbolo = "muR", Nome = "dμ_right", ValorPadrao = 1 }, new() { Simbolo = "muL", Nome = "dμ_left", ValorPadrao = 1, ValorMin = 0.0001 } ], VariavelResultado = "Δ(g)", UnidadeResultado = "", Calcular = v => v["muR"] / v["muL"] },
            new Formula { Id = "5_ah04", Nome = "Convolução em Grupo", Categoria = "Análise Harmônica", SubCategoria = "Operações", Expressao = "(f*g)(x)=∫ f(y)g(y^{-1}x)dμ(y)", ExprTexto = "convolução em G", Icone = "*", Descricao = "Generaliza convolução clássica para grupos.", Variaveis = [ new() { Simbolo = "f", Nome = "f médio", ValorPadrao = 2 }, new() { Simbolo = "g", Nome = "g médio", ValorPadrao = 3 } ], VariavelResultado = "(f*g)", UnidadeResultado = "", Calcular = v => v["f"] * v["g"] },
            new Formula { Id = "5_ah05", Nome = "Fourier em Grupo Abeliano", Categoria = "Análise Harmônica", SubCategoria = "Transformadas", Expressao = "f̂(χ)=∫ f(g)χ̄(g)dg", ExprTexto = "transformada de Fourier por caracteres", Icone = "f̂", Descricao = "Transforma função no grupo em função no dual Ĝ.", Variaveis = [ new() { Simbolo = "f", Nome = "Amplitude média de f", ValorPadrao = 2 }, new() { Simbolo = "chi", Nome = "χ̄ médio", ValorPadrao = 0.5 } ], VariavelResultado = "f̂(χ)", UnidadeResultado = "", Calcular = v => v["f"] * v["chi"] },
            new Formula { Id = "5_ah06", Nome = "Inversão de Fourier", Categoria = "Análise Harmônica", SubCategoria = "Transformadas", Expressao = "f(g)=∫_Ĝ f̂(χ)χ(g)dμ̂(χ)", ExprTexto = "inversão no dual", Icone = "inv", Descricao = "Recupera f a partir de sua transformada.", Variaveis = [ new() { Simbolo = "fh", Nome = "f̂ médio", ValorPadrao = 1.5 }, new() { Simbolo = "chi", Nome = "χ médio", ValorPadrao = 2 } ], VariavelResultado = "f(g)", UnidadeResultado = "", Calcular = v => v["fh"] * v["chi"] },
            new Formula { Id = "5_ah07", Nome = "Parseval", Categoria = "Análise Harmônica", SubCategoria = "Transformadas", Expressao = "∫|f|²dμ=∫|f̂|²dμ̂", ExprTexto = "norma L2 preservada", Icone = "L2", Descricao = "Conservação de energia entre domínio e frequência.", Variaveis = [ new() { Simbolo = "lhs", Nome = "∫|f|²", ValorPadrao = 4 }, new() { Simbolo = "rhs", Nome = "∫|f̂|²", ValorPadrao = 4 } ], VariavelResultado = "Diferença (deve ser 0)", UnidadeResultado = "", Calcular = v => v["lhs"] - v["rhs"] },
            new Formula { Id = "5_ah08", Nome = "Dualidade de Pontryagin", Categoria = "Análise Harmônica", SubCategoria = "Estrutura", Expressao = "(Ĝ)^ ≅ G", ExprTexto = "bidual canonicamente isomorfo", Icone = "^", Descricao = "Categoria dos grupos abelianos localmente compactos é autodual.", Variaveis = [ new() { Simbolo = "ok", Nome = "isomorfismo válido? (1/0)", ValorPadrao = 1, ValorMin = 0, ValorMax = 1 } ], VariavelResultado = "Válido?", UnidadeResultado = "", Calcular = v => v["ok"] },
            new Formula { Id = "5_ah09", Nome = "Convolução vira Produto", Categoria = "Análise Harmônica", SubCategoria = "Transformadas", Expressao = "(f*g)^ = f̂·ĝ", ExprTexto = "Fourier(conv)=produto", Icone = "conv", Descricao = "Teorema central que simplifica EDOs/PDEs via frequência.", Variaveis = [ new() { Simbolo = "fh", Nome = "f̂", ValorPadrao = 2 }, new() { Simbolo = "gh", Nome = "ĝ", ValorPadrao = 3 } ], VariavelResultado = "(f*g)^", UnidadeResultado = "", Calcular = v => v["fh"] * v["gh"] }
        ]);
    }
