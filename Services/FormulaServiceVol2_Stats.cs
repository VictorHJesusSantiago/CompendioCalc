    ...
    private void AdicionarSeriesTemporais()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "st_04", Nome = "Ruído Branco εₜ", Categoria = "Séries Temporais", SubCategoria = "Fundamentos",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "σ", Nome = "σ", ValorPadrao = 5 } ],
            ...
            new Formula { Id = "st_07", Nome = "Modelo AR(p)", Categoria = "Séries Temporais", SubCategoria = "ARIMA",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "c", Nome = "c", ValorPadrao = 10 }, new() { Simbolo = "Σᵢ", Nome = "Σᵢ", ValorPadrao = 5 } ],
            ...
            new Formula { Id = "st_08", Nome = "Modelo MA(q)", Categoria = "Séries Temporais", SubCategoria = "ARIMA",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "μ", Nome = "μ", ValorPadrao = 10 }, new() { Simbolo = "εₜ", Nome = "εₜ", ValorPadrao = 5 } ],
                VariavelResultado = "Xₜ",
                UnidadeResultado = "",
            ...
            new Formula { Id = "st_13", Nome = "Modelo ARCH(q)", Categoria = "Séries Temporais", SubCategoria = "Volatilidade",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "ω", Nome = "ω", ValorPadrao = 10 }, new() { Simbolo = "Σᵢ", Nome = "Σᵢ", ValorPadrao = 5 } ],
    ...
    private void AdicionarAnaliseMultivariada()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "mv_fa01", Nome = "Modelo Fatorial X = Λf + ε", Categoria = "Análise Multivariada", SubCategoria = "Fatorial/Clustering",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "μ", Nome = "μ", ValorPadrao = 10 }, new() { Simbolo = "Λf", Nome = "Λf", ValorPadrao = 5 } ],
                VariavelResultado = "X",
                UnidadeResultado = "",
            ...
            new Formula { Id = "mv_fa02", Nome = "Σ = ΛΛᵀ + Ψ", Categoria = "Análise Multivariada", SubCategoria = "Fatorial/Clustering",
                ...
                ExemploPratico = "Utilize os valores padrão para calcular o resultado.",
                Variaveis = [ new() { Simbolo = "ΛΛᵀ", Nome = "ΛΛᵀ", ValorPadrao = 10 }, new() { Simbolo = "Ψ", Nome = "Ψ", ValorPadrao = 5 } ],
                VariavelResultado = "Σ",
                UnidadeResultado = "",
