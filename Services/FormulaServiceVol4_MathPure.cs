...
public partial class FormulaService
{
    ...
    private void AdicionarGeometriaSipletica()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "ω", Nome = "Componente da forma ω", ValorPadrao = 1.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "Potência n (dim M = 2n)", ValorPadrao = 2, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "ω₀", Nome = "Valor base da forma ω", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "Grau n (dim=2n)", ValorPadrao = 2, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "dp", Nome = "Diferencial de momento dp", ValorPadrao = 0.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dq", Nome = "Diferencial de posição dq", ValorPadrao = 2.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "Número de graus de liberdade", ValorPadrao = 2, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "∂H∂p", Nome = "∂H/∂p (velocidade)", ValorPadrao = 0.4, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "∂H∂q", Nome = "∂H/∂q (força)", ValorPadrao = 0.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "Dimensão n (matriz 2n×2n)", ValorPadrao = 2, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "ω", Nome = "Forma simplética inicial", ValorPadrao = 1.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "ωⁿ", Nome = "ωⁿ", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 2, ValorMin = 0.001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "dimM", Nome = "Dimensão de M", ValorPadrao = 6, ValorMin = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "dimG", Nome = "Dimensão de G", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "μ₁", Nome = "Componente 1 do momento", ValorPadrao = 1.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "μ₂", Nome = "Componente 2 do momento", ValorPadrao = 2.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "∂f∂q", Nome = "∂f/∂q", ValorPadrao = 0.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "∂g∂p", Nome = "∂g/∂p", ValorPadrao = 2.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
    ...
    private void AdicionarTopologiaAlgebricaAvancada()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "imPrev", Nome = "rank Im(∂n)", ValorPadrao = 12, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kerNext", Nome = "rank Ker(∂n-1)", ValorPadrao = 12, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "ker", Nome = "rank Ker(∂n)", ValorPadrao = 14, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "im", Nome = "rank Im(∂n+1)", ValorPadrao = 9, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "n", Nome = "Grau maximo da resolução", ValorPadrao = 3, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "n",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "m", Nome = "Módulo m", ValorPadrao = 12, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "Módulo n", ValorPadrao = 18, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "hom", Nome = "dim Hom", ValorPadrao = 7, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ext", Nome = "dim Ext", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "torC", Nome = "rank Tor_n(C)", ValorPadrao = 5, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "torA", Nome = "rank Tor_{n-1}(A)", ValorPadrao = 3, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "kerf", Nome = "rank Ker(f)", ValorPadrao = 4, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "kerg", Nome = "rank Ker(g)", ValorPadrao = 6, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "cokf", Nome = "rank Coker(f)", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
            ...
            new Formula
            {
                ...
                Variaveis = [ new() { Simbolo = "tensor", Nome = "Contribuição tensorial", ValorPadrao = 11, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "tor", Nome = "Correção Tor", ValorPadrao = 2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Kunneth_n",
                UnidadeResultado = "",
                Calcular = vars => vars["tensor"] + vars["tor"],
                Unidades = "",
            },
            new Formula { Id = "4_ta01", Nome = "Grupo de Homologia H_n", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "H_n=ker ∂_n / Im ∂_{n+1}", ExprTexto = "Hn=ker/im", Icone = "Hn", Descricao = "Definição canônica de homologia singular.", ExemploPratico = "Exemplo: dim ker=12, dim im=5 => rank H=7.", Variaveis = [ new() { Simbolo = "ker", Nome = "dim ker", ValorPadrao = 12, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "im", Nome = "dim im", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "rank H_n", UnidadeResultado = "", Calcular = vars => vars["ker"] - vars["im"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta02", Nome = "Números de Betti", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "b_n = rank H_n", ExprTexto = "bn=rank(Hn)", Icone = "bn", Descricao = "Conta buracos n-dimensionais independentes.", ExemploPratico = "Exemplo: rank H1=3.", Variaveis = [ new() { Simbolo = "r", Nome = "Rank", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "b_n", UnidadeResultado = "", Calcular = vars => vars["r"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta03", Nome = "Características de Euler", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "χ=Σ(-1)^n b_n", ExprTexto = "chi=sum (-1)^n bn", Icone = "χ", Descricao = "Invariante topológico global do espaço.", ExemploPratico = "Exemplo: b0=1,b1=2,b2=1 => χ=0.", Variaveis = [ new() { Simbolo = "b0", Nome = "b0", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "b1", Nome = "b1", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "b2", Nome = "b2", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "χ", UnidadeResultado = "", Calcular = vars => vars["b0"] - vars["b1"] + vars["b2"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta04", Nome = "Cohomologia H^n", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "H^n=ker d^n / Im d^{n-1}", ExprTexto = "H^n=ker d / im d", Icone = "H^n", Descricao = "Versão dual da homologia com estrutura de anel.", ExemploPratico = "Exemplo: ker=10, im=4 => dim H^n=6.", Variaveis = [ new() { Simbolo = "ker", Nome = "dim ker", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "im", Nome = "dim im", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "dim H^n", UnidadeResultado = "", Calcular = vars => vars["ker"] - vars["im"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta05", Nome = "Produto Cup", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "\u222a:H^p×H^q→H^{p+q}", ExprTexto = "cup product degree add", Icone = "cup", Descricao = "Multiplicação em cohomologia que define anel graduado.", ExemploPratico = "Exemplo: p=2,q=3 => grau 5.", Variaveis = [ new() { Simbolo = "p", Nome = "Grau p", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "q", Nome = "Grau q", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "p+q", UnidadeResultado = "", Calcular = vars => vars["p"] + vars["q"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta06", Nome = "Dualidade de Poincare", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "H^k(M)≈H_{n-k}(M)", ExprTexto = "Poincare duality", Icone = "PD", Descricao = "Em variedades orientáveis compactas, homologia e cohomologia são dualmente relacionadas.", ExemploPratico = "Exemplo: n=6,k=2 => dual em H4.", Variaveis = [ new() { Simbolo = "n", Nome = "Dimensão n", ValorPadrao = 6, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "k", Nome = "Grau k", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "n-k", UnidadeResultado = "", Calcular = vars => vars["n"] - vars["k"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta07", Nome = "Sequência de Mayer-Vietoris", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "...→H_n(U∩V)→H_n(U)⊕H_n(V)→H_n(X)→...", ExprTexto = "MV exact sequence", Icone = "MV", Descricao = "Permite calcular homologia por decomposição de espaço.", ExemploPratico = "Exemplo: rank(U)+rank(V)-rank(U∩V).", Variaveis = [ new() { Simbolo = "u", Nome = "rank U", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v", Nome = "rank V", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "i", Nome = "rank interseção", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "estimativa", UnidadeResultado = "", Calcular = vars => vars["u"] + vars["v"] - vars["i"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta08", Nome = "Teorema de Hurewicz", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "π_n(X)→H_n(X)", ExprTexto = "hurewicz map", Icone = "Hur", Descricao = "Conecta grupos de homotopia com homologia em graus baixos.", ExemploPratico = "Exemplo: n=1 em espaço conexo por caminhos.", Variaveis = [ new() { Simbolo = "n", Nome = "Grau n", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "n", UnidadeResultado = "", Calcular = vars => vars["n"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta09", Nome = "Teorema Universal de Coeficientes", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "H^n(X;G)≈Hom(H_n,G)⊕Ext(H_{n-1},G)", ExprTexto = "UCT cohomology", Icone = "UCT", Descricao = "Relação entre homologia e cohomologia com coeficientes G.", ExemploPratico = "Exemplo: dimensão Hom=6 e Ext=1 => total 7.", Variaveis = [ new() { Simbolo = "hom", Nome = "dim Hom", ValorPadrao = 6, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "ext", Nome = "dim Ext", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "dim", UnidadeResultado = "", Calcular = vars => vars["hom"] + vars["ext"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta10", Nome = "Classe de Chern c1", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "c_1(E)∈H^2(X,Z)", ExprTexto = "c1 in H2", Icone = "c1", Descricao = "Primeira classe de Chern de fibrados complexos.", ExemploPratico = "Exemplo: c1=2 para fibrado de grau 2.", Variaveis = [ new() { Simbolo = "c1", Nome = "Valor de c1", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "c1", UnidadeResultado = "", Calcular = vars => vars["c1"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta11", Nome = "Classe de Stiefel-Whitney", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "w_i(E)∈H^i(X,Z2)", ExprTexto = "wi in Hi mod2", Icone = "wi", Descricao = "Classes características para fibrados reais.", ExemploPratico = "Exemplo: i=2.", Variaveis = [ new() { Simbolo = "i", Nome = "Índice i", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "i", UnidadeResultado = "", Calcular = vars => vars["i"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta12", Nome = "Classe de Pontryagin", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "p_i(E)∈H^{4i}(X,Z)", ExprTexto = "pi in H4i", Icone = "pi", Descricao = "Classes características para fibrados reais orientáveis.", ExemploPratico = "Exemplo: i=1 => grau 4.", Variaveis = [ new() { Simbolo = "i", Nome = "Índice i", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "4i", UnidadeResultado = "", Calcular = vars => 4 * vars["i"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta13", Nome = "Nervo de Cobertura", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "N(U)=complexo simplicial da cobertura U", ExprTexto = "nerve(U)", Icone = "N", Descricao = "Representa interseções de cobertura aberta por um complexo.", ExemploPratico = "Exemplo: 5 conjuntos com 7 interseções não vazias.", Variaveis = [ new() { Simbolo = "v", Nome = "Nº de conjuntos", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "e", Nome = "Interseções", ValorPadrao = 7, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "v+e", UnidadeResultado = "", Calcular = vars => vars["v"] + vars["e"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta14", Nome = "Dualidade de Alexander", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "\u0303H_i(S^n\\A)≈\u0303H^{n-i-1}(A)", ExprTexto = "alexander duality", Icone = "AD", Descricao = "Relaciona homologia do complemento com cohomologia do subconjunto.", ExemploPratico = "Exemplo: n=3,i=1 => grau cohomológico 1.", Variaveis = [ new() { Simbolo = "n", Nome = "Dimensão n", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "i", Nome = "Índice i", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "n-i-1", UnidadeResultado = "", Calcular = vars => vars["n"] - vars["i"] - 1,
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta15", Nome = "Par de Espaços", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "H_n(X,A)", ExprTexto = "relative homology", Icone = "(X,A)", Descricao = "Homologia relativa mede ciclos de X módulo A.", ExemploPratico = "Exemplo: rank(X)=8, rank(A)=3 => relativo 5.", Variaveis = [ new() { Simbolo = "x", Nome = "rank X", ValorPadrao = 8, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "a", Nome = "rank A", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "aprox", UnidadeResultado = "", Calcular = vars => vars["x"] - vars["a"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta16", Nome = "Colchete de Whitehead", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "[π_p,π_q]→π_{p+q-1}", ExprTexto = "whitehead bracket", Icone = "[ , ]", Descricao = "Operação não linear em grupos de homotopia.", ExemploPratico = "Exemplo: p=2,q=3 => grau 4.", Variaveis = [ new() { Simbolo = "p", Nome = "p", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "q", Nome = "q", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "p+q-1", UnidadeResultado = "", Calcular = vars => vars["p"] + vars["q"] - 1,
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta17", Nome = "Homotopia Estável", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "π_n^s=lim_k π_{n+k}(S^k)", ExprTexto = "stable homotopy", Icone = "πs", Descricao = "Grupo de homotopia no regime de estabilização por suspensão.", ExemploPratico = "Exemplo: n=3.", Variaveis = [ new() { Simbolo = "n", Nome = "Índice n", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "n", UnidadeResultado = "", Calcular = vars => vars["n"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ta18", Nome = "Classe Fundamental", Categoria = "Topologia Algébrica Avançada", SubCategoria = "Topologia Algébrica", Expressao = "[M]∈H_n(M,Z)", ExprTexto = "fundamental class", Icone = "[M]", Descricao = "Classe canônica de variedade orientável compacta n-dimensional.", ExemploPratico = "Exemplo: esfera S2 tem [S2] em H2.", Variaveis = [ new() { Simbolo = "n", Nome = "Dimensão n", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "n", UnidadeResultado = "", Calcular = vars => vars["n"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
        ]);
    ...
    private void AdicionarFormasModulares()
    {
        _formulas.AddRange([
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "gamma", Nome = "gamma", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "gamma", Nome = "gamma", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "tau", Nome = "tau", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "f", Nome = "f", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "gamma", Nome = "gamma", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "~1847",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "tau", Nome = "tau", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m", Nome = "m", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "sigma", Nome = "sigma", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "q", Nome = "q", ValorPadrao = 5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "η",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "j", Nome = "j", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "tau", Nome = "tau", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1937",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "d", Nome = "d", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "a", Nome = "a", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "4_fm11", Nome = "Parâmetro Modular", Categoria = "Formas Modulares", SubCategoria = "Formas Modulares", Expressao = "τ=x+iy, y>0", ExprTexto = "tau in upper half-plane", Icone = "τ", Descricao = "Parâmetro principal de formas modulares no semiplano superior.", ExemploPratico = "Exemplo: x=0.2,y=1.5 => |τ|≈1.51.", Variaveis = [ new() { Simbolo = "x", Nome = "Parte real", ValorPadrao = 0.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y", Nome = "Parte imaginária", ValorPadrao = 1.5, ValorMin = 0.0001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "|τ|", UnidadeResultado = "", Calcular = vars => Math.Sqrt(vars["x"] * vars["x"] + vars["y"] * vars["y"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_fm12", Nome = "q-Expansão Truncada", Categoria = "Formas Modulares", SubCategoria = "Formas Modulares", Expressao = "q=e^{2πiτ}", ExprTexto = "|q|=exp(-2*pi*Im(tau))", Icone = "q", Descricao = "Magnitude de q controla convergência da expansão de Fourier.", ExemploPratico = "Exemplo: Im(τ)=1 => |q|≈0.001867.", Variaveis = [ new() { Simbolo = "Imτ", Nome = "Parte imaginária de τ", ValorPadrao = 1, ValorMin = 0.0001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "|q|", UnidadeResultado = "", Calcular = vars => Math.Exp(-2 * Math.PI * vars["Imτ"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_fm13", Nome = "Série de Eisenstein E_k", Categoria = "Formas Modulares", SubCategoria = "Formas Modulares", Expressao = "E_k=1-(2k/B_k)Σσ_{k-1}(n)q^n", ExprTexto = "Ek from divisor sums", Icone = "Ek", Descricao = "Expressão padrão para formas de Eisenstein normalizadas.", ExemploPratico = "Exemplo: k=4 e termo sigma=10.", Variaveis = [ new() { Simbolo = "k", Nome = "Peso k", ValorPadrao = 4, ValorMin = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "σ", Nome = "Soma de divisores", ValorPadrao = 10, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "k+σ", UnidadeResultado = "", Calcular = vars => vars["k"] + vars["σ"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_fm14", Nome = "Discriminante Δ(τ)", Categoria = "Formas Modulares", SubCategoria = "Formas Modulares", Expressao = "Δ=q∏(1-q^n)^{24}", ExprTexto = "Delta from q-product", Icone = "Δ", Descricao = "Forma cúspide de peso 12 usada em teoria de curvas elípticas.", ExemploPratico = "Exemplo: q=0.01 => Δ pequeno positivo.", Variaveis = [ new() { Simbolo = "q", Nome = "Parâmetro q", ValorPadrao = 0.01, ValorMin = 0.0000001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "q^24", UnidadeResultado = "", Calcular = vars => Math.Pow(vars["q"], 24),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_fm15", Nome = "j-Invariante Aproximado", Categoria = "Formas Modulares", SubCategoria = "Formas Modulares", Expressao = "j(τ)=E_4(τ)^3/Δ(τ)", ExprTexto = "j=E4^3/Delta", Icone = "j", Descricao = "Invariante completo de classes de curvas elípticas sobre C.", ExemploPratico = "Exemplo: E4=2, Δ=0.5 => j=16.", Variaveis = [ new() { Simbolo = "E4", Nome = "E4", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "Δ", Nome = "Delta", ValorPadrao = 0.5, ValorMin = 0.0001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "j", UnidadeResultado = "", Calcular = vars => Math.Pow(vars["E4"], 3) / vars["Δ"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            ...
            new Formula
            {
                ...
                AnoOrigin = "1859/1737",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "zeta", Nome = "zeta", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "s", Nome = "s", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1859",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "xi", Nome = "xi", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "s", Nome = "s", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "zeta", Nome = "zeta", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "n", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1837",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "L", Nome = "L", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "s", Nome = "s", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1837",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "gcd", Nome = "gcd", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "a", Nome = "a", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1965",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "L", Nome = "L", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "E", Nome = "E", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
    ...
    private void AdicionarTeoriaErgodica()
    {
        _formulas.AddRange([
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "X", Nome = "X", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "F", Nome = "F", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "A", Nome = "A", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "A", Nome = "A", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1958/1959",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "h", Nome = "h", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                AnoOrigin = "1970",
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "h", Nome = "h", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula
            {
                ...
                ExemploPratico = "Exemplo: substitua as variáveis pelos valores do seu cenário para obter o resultado numérico desta fórmula.",
                Variaveis = [ new() { Simbolo = "T", Nome = "T", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "mu", Nome = "mu", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ],
                VariavelResultado = "Resultado",
                UnidadeResultado = "",
            ...
            new Formula { Id = "4_te01", Nome = "Sistema Medido", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "(X,μ,T)", ExprTexto = "X,mu,T", Icone = "TE", Descricao = "Tripla básica de teoria ergódica com medida invariante.", ExemploPratico = "Exemplo: μ(X)=1.", Variaveis = [ new() { Simbolo = "μ", Nome = "Massa total μ", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "μ", UnidadeResultado = "", Calcular = vars => vars["μ"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te02", Nome = "Invariância de Medida", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "μ(T^{-1}A)=μ(A)", ExprTexto = "measure invariant", Icone = "μ", Descricao = "Condição de preservação de medida sob transformação T.", ExemploPratico = "Exemplo: μ(A)=0.3.", Variaveis = [ new() { Simbolo = "μA", Nome = "Medida de A", ValorPadrao = 0.3, ValorMin = 0, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "μ(A)", UnidadeResultado = "", Calcular = vars => vars["μA"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te03", Nome = "Média Temporal", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "A_Nf=(1/N)Σ_{k=0}^{N-1}f(T^kx)", ExprTexto = "ANf mean along orbit", Icone = "AN", Descricao = "Média de observável f ao longo da órbita de x.", ExemploPratico = "Exemplo: soma=27,N=9 => 3.", Variaveis = [ new() { Simbolo = "Σ", Nome = "Soma temporal", ValorPadrao = 27, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "N", Nome = "Número de passos", ValorPadrao = 9, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "A_Nf", UnidadeResultado = "", Calcular = vars => vars["Σ"] / vars["N"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te04", Nome = "Média Espacial", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "∫f dμ", ExprTexto = "space mean", Icone = "int", Descricao = "Valor médio global do observável com respeito à medida invariante.", ExemploPratico = "Exemplo: integral aproximada 2.7.", Variaveis = [ new() { Simbolo = "I", Nome = "Integral", ValorPadrao = 2.7, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "∫f dμ", UnidadeResultado = "", Calcular = vars => vars["I"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te05", Nome = "Critério de Ergodicidade", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "A invariante => μ(A) in {0,1}", ExprTexto = "ergodic invariant sets", Icone = "erg", Descricao = "Conjuntos invariantes só têm medida trivial.", ExemploPratico = "Exemplo: μ(A)=1 para conjunto total.", Variaveis = [ new() { Simbolo = "μA", Nome = "Medida μ(A)", ValorPadrao = 1, ValorMin = 0, ValorMax = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "μ(A)", UnidadeResultado = "", Calcular = vars => vars["μA"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te06", Nome = "Mixing", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "μ(A∩T^{-n}B)→μ(A)μ(B)", ExprTexto = "mixing limit", Icone = "mix", Descricao = "Perda assintótica de correlação entre eventos.", ExemploPratico = "Exemplo: μ(A)=0.4,μ(B)=0.5 => limite 0.2.", Variaveis = [ new() { Simbolo = "μA", Nome = "μ(A)", ValorPadrao = 0.4, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "μB", Nome = "μ(B)", ValorPadrao = 0.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "μ(A)μ(B)", UnidadeResultado = "", Calcular = vars => vars["μA"] * vars["μB"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te07", Nome = "Entropia Métrica", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "h_μ(T)=sup_P h_μ(T,P)", ExprTexto = "metric entropy", Icone = "h", Descricao = "Taxa de produção de informação do sistema dinâmico.", ExemploPratico = "Exemplo: h=0.69 para mapa caótico simples.", Variaveis = [ new() { Simbolo = "h", Nome = "Entropia h", ValorPadrao = 0.69, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "h", UnidadeResultado = "", Calcular = vars => vars["h"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te08", Nome = "Entropia de Partição", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "H(P)=-Σ p_i log p_i", ExprTexto = "Shannon partition entropy", Icone = "H", Descricao = "Entropia de Shannon associada a partição mensurável.", ExemploPratico = "Exemplo: p=0.25 => termo 0.3466.", Variaveis = [ new() { Simbolo = "p", Nome = "Probabilidade p", ValorPadrao = 0.25, ValorMin = 0.000001, ValorMax = 0.999999, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "-p log p", UnidadeResultado = "", Calcular = vars => -vars["p"] * Math.Log(vars["p"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te09", Nome = "Correlações Temporais", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "C_n=∫f·f∘T^n dμ-(∫f dμ)^2", ExprTexto = "correlation decay", Icone = "Cn", Descricao = "Mede memória dinâmica em n passos.", ExemploPratico = "Exemplo: termo1=1.2, média=1.0 => Cn=0.2.", Variaveis = [ new() { Simbolo = "t1", Nome = "Integral conjunta", ValorPadrao = 1.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m", Nome = "Média", ValorPadrao = 1.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "C_n", UnidadeResultado = "", Calcular = vars => vars["t1"] - vars["m"] * vars["m"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_te10", Nome = "Expoente de Lyapunov Médio", Categoria = "Teoria Ergódica", SubCategoria = "Teoria Ergódica", Expressao = "λ=lim (1/n)Σ log|T'(x_k)|", ExprTexto = "lambda mean log derivative", Icone = "λ", Descricao = "Sensibilidade média a condições iniciais no regime ergódico.", ExemploPratico = "Exemplo: soma logs=4.5,n=10 => 0.45.", Variaveis = [ new() { Simbolo = "Σ", Nome = "Soma dos logs", ValorPadrao = 4.5, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "Passos n", ValorPadrao = 10, ValorMin = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "λ", UnidadeResultado = "", Calcular = vars => vars["Σ"] / vars["n"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
        ]);
    ...
    private void AdicionarAnalisePAdica()
    {
        _formulas.AddRange([
            ...
            new Formula { Id = "4_ap01", Nome = "Norma p-Ádica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "|x|_p=p^{-v_p(x)}", ExprTexto = "p-adic norm", Icone = "|.|p", Descricao = "Definição principal da norma p-ádica.", ExemploPratico = "Exemplo: v_p(x)=3,p=5 => |x|p=1/125.", Variaveis = [ new() { Simbolo = "p", Nome = "Primo p", ValorPadrao = 5, ValorMin = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "v", Nome = "Valoração v_p(x)", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "|x|_p", UnidadeResultado = "", Calcular = vars => Math.Pow(vars["p"], -vars["v"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap02", Nome = "Ultramétrica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "|x+y|_p<=max(|x|_p,|y|_p)", ExprTexto = "ultrametric inequality", Icone = "ultra", Descricao = "Desigualdade fundamental dos p-ádicos.", ExemploPratico = "Exemplo: |x|=0.2,|y|=0.04 => bound 0.2.", Variaveis = [ new() { Simbolo = "x", Nome = "|x|_p", ValorPadrao = 0.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y", Nome = "|y|_p", ValorPadrao = 0.04, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "max", UnidadeResultado = "", Calcular = vars => Math.Max(vars["x"], vars["y"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap03", Nome = "Série Geométrica p-Ádica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "Σ_{n>=0}x^n=1/(1-x), |x|_p<1", ExprTexto = "geometric converges if |x|p<1", Icone = "Σ", Descricao = "Convergência em norma p-ádica para termos pequenos.", ExemploPratico = "Exemplo: x=1/5 => soma=1.25.", Variaveis = [ new() { Simbolo = "x", Nome = "Termo x", ValorPadrao = 0.2, ValorMin = -0.999, ValorMax = 0.999, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "1/(1-x)", UnidadeResultado = "", Calcular = vars => 1.0 / (1.0 - vars["x"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap04", Nome = "Distância p-Ádica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "d_p(x,y)=|x-y|_p", ExprTexto = "dp=|x-y|p", Icone = "dp", Descricao = "Métrica induzida pela norma p-ádica.", ExemploPratico = "Exemplo: x=1.2,y=1.0 => 0.2 (modelo numérico).", Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 1.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y", Nome = "y", ValorPadrao = 1.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "d_p", UnidadeResultado = "", Calcular = vars => Math.Abs(vars["x"] - vars["y"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap05", Nome = "Bola p-Ádica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "B_r(a)={x:|x-a|_p<=r}", ExprTexto = "p-adic ball", Icone = "Br", Descricao = "Bolas são simultaneamente abertas e fechadas.", ExemploPratico = "Exemplo: r=0.125.", Variaveis = [ new() { Simbolo = "r", Nome = "Raio r", ValorPadrao = 0.125, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "r", UnidadeResultado = "", Calcular = vars => vars["r"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap06", Nome = "Inteiros p-Ádicos", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "Z_p={x:|x|_p<=1}", ExprTexto = "Zp unit ball", Icone = "Zp", Descricao = "Anel compacto local de inteiros p-ádicos.", ExemploPratico = "Exemplo: |x|p=0.2 pertence a Zp.", Variaveis = [ new() { Simbolo = "|x|", Nome = "Norma p-ádica", ValorPadrao = 0.2, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "indicador", UnidadeResultado = "", Calcular = vars => vars["|x|"] <= 1 ? 1 : 0,
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap07", Nome = "Unidades p-Ádicas", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "Z_p^*=\u007Bx:|x|_p=1\u007D", ExprTexto = "units have norm 1", Icone = "U", Descricao = "Elementos invertíveis de Z_p.", ExemploPratico = "Exemplo: |x|p=1 => unidade.", Variaveis = [ new() { Simbolo = "|x|", Nome = "Norma p-ádica", ValorPadrao = 1, ValorMin = 0, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "indicador", UnidadeResultado = "", Calcular = vars => Math.Abs(vars["|x|"] - 1) < 1e-9 ? 1 : 0,
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap08", Nome = "Lema de Hensel (passo)", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "x_{k+1}=x_k-f(x_k)/f'(x_k)", ExprTexto = "p-adic Newton step", Icone = "H", Descricao = "Iteração tipo Newton em contexto p-ádico.", ExemploPratico = "Exemplo: x=2,f=0.1,fp=1.2 => 1.9167.", Variaveis = [ new() { Simbolo = "x", Nome = "x_k", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "f", Nome = "f(x_k)", ValorPadrao = 0.1, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "fp", Nome = "f'(x_k)", ValorPadrao = 1.2, ValorMin = 0.0001, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "x_{k+1}", UnidadeResultado = "", Calcular = vars => vars["x"] - vars["f"] / vars["fp"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap09", Nome = "Medida de Haar em Z_p", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "μ(Z_p)=1", ExprTexto = "haar normalized", Icone = "μ", Descricao = "Normalização padrão da medida aditiva em Z_p.", ExemploPratico = "Exemplo: μ(Zp)=1.", Variaveis = [ new() { Simbolo = "μ", Nome = "Medida", ValorPadrao = 1, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "μ", UnidadeResultado = "", Calcular = vars => vars["μ"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap10", Nome = "Transformada de Mahler", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "f(x)=Σ a_n binom(x,n)", ExprTexto = "mahler expansion", Icone = "M", Descricao = "Expansão de funções contínuas em base binomial p-ádica.", ExemploPratico = "Exemplo: n=4,a_n=0.2 => termo 0.8.", Variaveis = [ new() { Simbolo = "a", Nome = "Coeficiente a_n", ValorPadrao = 0.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "n", Nome = "Índice n", ValorPadrao = 4, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "a_n*n", UnidadeResultado = "", Calcular = vars => vars["a"] * vars["n"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap11", Nome = "Log p-Ádico", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "log_p(1+x)=Σ(-1)^{n+1}x^n/n", ExprTexto = "p-adic log series", Icone = "log", Descricao = "Série convergente para |x|_p<1.", ExemploPratico = "Exemplo: x=0.1 => ~0.0953.", Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 0.1, ValorMin = -0.999, ValorMax = 0.999, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "log_p(1+x)", UnidadeResultado = "", Calcular = vars => Math.Log(1 + vars["x"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap12", Nome = "Exp p-Ádica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "exp_p(x)=Σx^n/n!", ExprTexto = "p-adic exp", Icone = "exp", Descricao = "Série exponencial em domínio de convergência p-ádico.", ExemploPratico = "Exemplo: x=0.2 => ~1.2214.", Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 0.2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "exp_p(x)", UnidadeResultado = "", Calcular = vars => Math.Exp(vars["x"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap13", Nome = "Medida de Valoração", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "v_p(xy)=v_p(x)+v_p(y)", ExprTexto = "valuation additive", Icone = "vp", Descricao = "A valoração é homomorfismo multiplicativo para aditivo.", ExemploPratico = "Exemplo: vp(x)=2,vp(y)=3 => vp(xy)=5.", Variaveis = [ new() { Simbolo = "vx", Nome = "v_p(x)", ValorPadrao = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "vy", Nome = "v_p(y)", ValorPadrao = 3, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "v_p(xy)", UnidadeResultado = "", Calcular = vars => vars["vx"] + vars["vy"],
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap14", Nome = "Série de Laurent p-Ádica", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "x=Σ_{k=m}^{∞}a_k p^k", ExprTexto = "laurent p-adic", Icone = "Laur", Descricao = "Representação padrão de elementos de Q_p.", ExemploPratico = "Exemplo: p=5,m=-2 => termo inicial 1/25.", Variaveis = [ new() { Simbolo = "p", Nome = "p", ValorPadrao = 5, ValorMin = 2, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "m", Nome = "Expoente inicial", ValorPadrao = -2, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "p^m", UnidadeResultado = "", Calcular = vars => Math.Pow(vars["p"], vars["m"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
            new Formula { Id = "4_ap15", Nome = "Módulo p-Ádico de Diferença", Categoria = "Análise p-Ádica", SubCategoria = "Análise p-ádica", Expressao = "|x-y|_p", ExprTexto = "p-adic distance core", Icone = "|.|", Descricao = "Quantidade base para convergência e continuidade em Q_p.", ExemploPratico = "Exemplo: x=2.0,y=1.7 => 0.3 (modelo numérico).", Variaveis = [ new() { Simbolo = "x", Nome = "x", ValorPadrao = 2.0, Descricao = "Parâmetro de entrada.", Unidade = "adim" }, new() { Simbolo = "y", Nome = "y", ValorPadrao = 1.7, Descricao = "Parâmetro de entrada.", Unidade = "adim" } ], VariavelResultado = "|x-y|", UnidadeResultado = "", Calcular = vars => Math.Abs(vars["x"] - vars["y"]),
                Criador = "Equipe CompendioCalc",
                AnoOrigin = "Séc. XX",
                Unidades = "", },
        ]);
